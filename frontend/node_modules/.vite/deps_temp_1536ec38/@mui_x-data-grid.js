...
var createEmotionCache = (options) => {
  const cache3 = createCache(options);
  class MyStyleSheet extends StyleSheet {
    constructor(args) {
      super(args);
      this.prepend = cache3.sheet.prepend;
    }
  }
  cache3.sheet = new MyStyleSheet({
    key: cache3.key,
    nonce: cache3.sheet.nonce,
    container: cache3.sheet.container,
    speedy: cache3.sheet.isSpeedy,
    prepend: cache3.sheet.prepend,
    insertionPoint: cache3.sheet.insertionPoint
  });
  return cache3;
};
var cache;
...
function composeClasses3(slots, getUtilityClass, classes2 = void 0) {
  const output = {};
...
var useUtilityClasses = (ownerState, componentName) => {
  ...
  return composeClasses3(slots, getContainerUtilityClass, classes2);
};
...
function createGrid(options = {}) {
  ...
  const Grid2 = React35.forwardRef(function Grid3(inProps, ref) {
    ...
    return (0, import_jsx_runtime12.jsx)(GridRoot3, {
      ref,
      as: component,
      ownerState,
      className: clsx_default(classes2.root, className),
      ...
      children: React35.Children.map(children, (child) => {
        var _a;
        if (React35.isValidElement(child) && isMuiElement2(child, ["Grid"])) {
...
function fastMemo(component) {
  return React37.memo(component, fastObjectShallowCompare);
}
...
function lruMemoize(func, equalityCheckOrOptions) {
  ...
  let resultsCount = 0;
  const cache3 = maxSize <= 1 ? createSingletonCache(comparator) : createLruCache(maxSize, comparator);
  function memoized() {
    let value = cache3.get(arguments);
    if (value === NOT_FOUND) {
      value = func.apply(null, arguments);
      resultsCount++;
      if (resultEqualityCheck) {
        const entries = cache3.getEntries();
...
var GridEditInputCell = React40.forwardRef((props, ref) => {
  ...
  return (0, import_jsx_runtime14.jsx)(GridEditInputCellRoot, _extends({
    ...
    endAdornment: isProcessingProps ? (0, import_jsx_runtime14.jsx)(rootProps.slots.loadIcon, {
      fontSize: "small",
      color: "action"
    }) : void 0
  }, other));
...
function GridFilterInputValue(props) {
  ...
  const [filterValueState, setFilterValueState] = React41.useState(item.value ?? "");
  const [applying, setIsApplying] = React41.useState(false);
  const id = useId();
  const rootProps = useGridRootProps();
  ...
  return (0, import_jsx_runtime15.jsx)(rootProps.slots.baseTextField, _extends({
    id,
    ...
    InputProps: _extends({}, applying || clearButton ? {
      endAdornment: applying ? (0, import_jsx_runtime15.jsx)(rootProps.slots.loadIcon, {
        fontSize: "small",
        color: "action"
      }) : clearButton
    } : {}, {
...
function GridMenu(props) {
  ...
  const savedFocusRef = React43.useRef(null);
  useEnhancedEffect_default(() => {
    var _a2, _b;
    if (open) {
...
function GridActionsCell(props) {
  ...
  const [focusedButtonIndex, setFocusedButtonIndex] = React44.useState(-1);
  const [open, setOpen] = React44.useState(false);
  const apiRef = useGridApiContext();
  const rootRef = React44.useRef(null);
  const buttonRef = React44.useRef(null);
  const ignoreCallToFocus = React44.useRef(false);
  const touchRippleRefs = React44.useRef({});
  const isRtl = useRtl();
  const menuId = useId();
  ...
  React44.useImperativeHandle(focusElementRef, () => ({
    focus() {
  ...
  return (0, import_jsx_runtime18.jsxs)("div", _extends({
    ...
    children: [iconButtons.map((button, index) => React44.cloneElement(button, {
      key: index,
      touchRippleRef: handleTouchRippleRef(index),
      onClick: handleButtonClick(index, button.props.onClick),
      tabIndex: focusedButtonIndex === index ? tabIndex : -1
    })), menuButtons.length > 0 && buttonId && (0, import_jsx_runtime18.jsx)(rootProps.slots.baseIconButton, _extends({
      ref: buttonRef,
      id: buttonId,
      ...
      children: (0, import_jsx_runtime18.jsx)(rootProps.slots.moreActionsIcon, {
        fontSize: "small"
      })
      ...
      children: (0, import_jsx_runtime18.jsx)(MenuList_default, {
        ...
        variant: "menu",
        autoFocusItem: true,
        children: menuButtons.map((button, index) => React44.cloneElement(button, {
          key: index,
          closeMenu: hideMenu
        }))
      })
...
function GridBooleanCellRaw(props) {
  ...
  const Icon = React45.useMemo(() => value ? rootProps.slots.booleanCellTrueIcon : rootProps.slots.booleanCellFalseIcon, [rootProps.slots.booleanCellFalseIcon, rootProps.slots.booleanCellTrueIcon, value]);
  return (0, import_jsx_runtime19.jsx)(Icon, _extends({
    fontSize: "small",
    className: classes2.root,
...
var GridBooleanCell = React45.memo(GridBooleanCellRaw);
var renderBooleanCell = (params) => {
  if (params.field !== "__row_group_by_columns_group__" && isAutogeneratedRowNode(params.rowNode)) {
    return "";
  }
  return (0, import_jsx_runtime19.jsx)(GridBooleanCell, _extends({}, params));
};
...
function GridEditBooleanCell(props) {
  ...
  const id = useId();
  const [valueState, setValueState] = React46.useState(value);
  const rootProps = useGridRootProps();
  const ownerState = {
    classes: rootProps.classes
  };
  const classes2 = useUtilityClasses5(ownerState);
  const handleChange = React46.useCallback(async (event) => {
  ...
  return (0, import_jsx_runtime20.jsx)("label", _extends({
    htmlFor: id,
    className: clsx_default(classes2.root, className)
  }, other, {
    children: (0, import_jsx_runtime20.jsx)(rootProps.slots.baseCheckbox, _extends({
      id,
      inputRef,
...
var renderEditBooleanCell = (params) => (0, import_jsx_runtime20.jsx)(GridEditBooleanCell, _extends({}, params));
...
function GridFilterInputBoolean(props) {
  ...
  const [filterValueState, setFilterValueState] = React47.useState(item.value || "");
  const rootProps = useGridRootProps();
  const labelId = useId();
  ...
  return (0, import_jsx_runtime21.jsxs)(BooleanOperatorContainer, {
    children: [(0, import_jsx_runtime21.jsxs)(rootProps.slots.baseFormControl, {
      fullWidth: true,
      children: [(0, import_jsx_runtime21.jsx)(rootProps.slots.baseInputLabel, _extends({}, (_c = rootProps.slotProps) == null ? void 0 : _c.baseInputLabel, {
        id: labelId,
        shrink: true,
        variant,
        children: label
      })), (0, import_jsx_runtime21.jsxs)(rootProps.slots.baseSelect, _extends({
        labelId,
        id: selectId,
        label,
        value: filterValueState,
        ...
        children: [(0, import_jsx_runtime21.jsx)(rootProps.slots.baseSelectOption, _extends({}, baseSelectOptionProps, {
          native: isSelectNative,
          value: "",
          children: apiRef.current.getLocaleText("filterValueAny")
        })), (0, import_jsx_runtime21.jsx)(rootProps.slots.baseSelectOption, _extends({}, baseSelectOptionProps, {
          native: isSelectNative,
          value: "true",
...
function useGridLogger(privateApiRef, name) {
  const logger = React50.useRef(null);
  if (logger.current) {
...
var useGridNativeEventListener = (apiRef, ref, eventName, handler, options) => {
  ...
  const [added, setAdded] = React51.useState(false);
  const handlerRef = React51.useRef(handler);
  const targetElement = isFunction(ref) ? ref() : (ref == null ? void 0 : ref.current) ?? null;
  const wrapHandler = React51.useCallback((event) => {
...
var useFirstRender = (callback) => {
  const isFirstRender = React52.useRef(true);
  if (isFirstRender.current) {
    isFirstRender.current = false;
    callback();
  }
...
var useRunOnce = (condition, effect) => {
  const didRun = React53.useRef(false);
  useEnhancedEffect_default(() => {
...
var GridHeaderCheckbox = React54.forwardRef(function GridHeaderCheckbox2(props, ref) {
  var _a;
  const other = _objectWithoutPropertiesLoose(props, _excluded10);
  const [, forceUpdate] = React54.useState(false);
  const apiRef = useGridApiContext();
  const rootProps = useGridRootProps();
  const ownerState = {
    classes: rootProps.classes
  ...
  const filteredSelection = React54.useMemo(() => {
  ...
  const selectionCandidates = React54.useMemo(() => {
  ...
  const currentSelectionSize = React54.useMemo(() => filteredSelection.filter((id) => selectionCandidates[id]).length, [filteredSelection, selectionCandidates]);
  ...
  const handleSelectionChange = React54.useCallback(() => {
    forceUpdate((p) => !p);
  }, []);
  React54.useEffect(() => {
...
var GRID_CHECKBOX_SELECTION_COL_DEF = _extends({}, GRID_BOOLEAN_COL_DEF, {
  ...
  renderHeader: (params) => (0, import_jsx_runtime24.jsx)(GridHeaderCheckbox, _extends({}, params)),
  renderCell: (params) => (0, import_jsx_runtime24.jsx)(GridCellCheckboxRenderer2, _extends({}, params))
});
...
function GridFilterInputDate(props) {
  ...
  const filterTimeout = useTimeout();
  const [filterValueState, setFilterValueState] = React56.useState(() => convertFilterItemValueToInputValue(item.value, type));
  ...
  return (0, import_jsx_runtime25.jsx)(rootProps.slots.baseTextField, _extends({
    fullWidth: true,
    id,
    label: apiRef.current.getLocaleText("filterPanelInputLabel"),
    placeholder: apiRef.current.getLocaleText("filterPanelInputPlaceholder"),
    ...
    inputRef: focusElementRef,
    InputProps: _extends({}, applying || clearButton ? {
      endAdornment: applying ? (0, import_jsx_runtime25.jsx)(rootProps.slots.loadIcon, {
        fontSize: "small",
        color: "action"
      }) : clearButton
    } : {}, {
...
function GridEditDateCell(props) {
  ...
  const valueTransformed = React57.useMemo(() => {
    let parsedDate;
    if (valueProp == null) {
      parsedDate = null;
  ...
  const [valueState, setValueState] = React57.useState(valueTransformed);
  const rootProps = useGridRootProps();
  const ownerState = {
    classes: rootProps.classes
  };
  const classes2 = useUtilityClasses8(ownerState);
  const parseValueToDate = React57.useCallback((value) => {
    if (value === "") {
      return null;
    }
  ...
  const handleChange = React57.useCallback(async (event) => {
  ...
  return (0, import_jsx_runtime26.jsx)(StyledInputBase, _extends({
    inputRef,
    fullWidth: true,
    className: classes2.root,
...
var renderEditDateCell = (params) => (0, import_jsx_runtime26.jsx)(GridEditDateCell, _extends({}, params));
...
function GridEditSingleSelectCell(props) {
  ...
  const [open, setOpen] = React58.useState(initialOpen);
  const baseSelectProps = ((_a = rootProps.slotProps) == null ? void 0 : _a.baseSelect) || {};
  const isSelectNative = baseSelectProps.native ?? false;
  ...
  return (0, import_jsx_runtime27.jsx)(rootProps.slots.baseSelect, _extends({
    ref,
    inputRef,
    value: valueProp,
    onChange: handleChange,
...
var renderEditSingleSelectCell = (params) => (0, import_jsx_runtime27.jsx)(GridEditSingleSelectCell, _extends({}, params));
...
function GridFilterInputSingleSelect(props) {
  ...
  const currentValueOptions = React59.useMemo(() => {
  ...
  const label = labelProp ?? apiRef.current.getLocaleText("filterPanelInputLabel");
  return (0, import_jsx_runtime28.jsxs)(SingleSelectOperatorContainer, {
    children: [(0, import_jsx_runtime28.jsxs)(rootProps.slots.baseFormControl, {
      fullWidth: true,
      children: [(0, import_jsx_runtime28.jsx)(rootProps.slots.baseInputLabel, _extends({}, (_c = rootProps.slotProps) == null ? void 0 : _c.baseInputLabel, {
        id: labelId,
        htmlFor: id,
        shrink: true,
        variant,
        children: label
      })), (0, import_jsx_runtime28.jsx)(rootProps.slots.baseSelect, _extends({
        id,
        label,
        labelId,
        value: filterValue,
...
function GridFilterInputMultipleSingleSelect(props) {
  ...
  const getOptionValue = resolvedColumn == null ? void 0 : resolvedColumn.getOptionValue;
  const getOptionLabel = resolvedColumn == null ? void 0 : resolvedColumn.getOptionLabel;
  const isOptionEqualToValue = React60.useCallback((option, value) => getOptionValue(option) === getOptionValue(value), [getOptionValue]);
  const resolvedValueOptions = React60.useMemo(() => {
    return getValueOptions(resolvedColumn) || [];
  }, [resolvedColumn]);
  const filteredValues = React60.useMemo(() => {
  ...
  const handleChange = React60.useCallback((event, value) => {
    applyValue(_extends({}, item, {
      value: value.map(getOptionValue)
    }));
  }, [applyValue, item, getOptionValue]);
  return (0, import_jsx_runtime29.jsx)(Autocomplete_default, _extends({
    multiple: true,
    ...
    renderTags: (value, getTagProps) => value.map((option, index) => {
      ...
      return (0, import_jsx_runtime29.jsx)(rootProps.slots.baseChip, _extends({
        variant: "outlined",
        size: "small",
    ...
    renderInput: (params) => {
      var _a;
      return (0, import_jsx_runtime29.jsx)(rootProps.slots.baseTextField, _extends({}, params, {
        label: apiRef.current.getLocaleText("filterPanelInputLabel"),
        placeholder: apiRef.current.getLocaleText("filterPanelInputPlaceholder"),
        InputLabelProps: _extends({}, params.InputLabelProps, {
          shrink: true
...
function GridScrollAreaRaw(props) {
  ...
  const scrollPosition = React61.useRef({
    left: 0,
    top: 0
  });
  ...
  const [canScrollMore, setCanScrollMore] = React61.useState(getCanScrollMore);
  const rootProps = useGridRootProps();
  ...
  return (0, import_jsx_runtime30.jsx)(GridScrollAreaRawRoot, {
    ref: rootRef,
...
function useResizeObserver(ref, fn, enabled) {
  const fnRef = React62.useRef(null);
  fnRef.current = fn;
  useEnhancedEffect_default(() => {
...
var GridPrivateApiContext = React63.createContext(void 0);
if (true) {
  GridPrivateApiContext.displayName = "GridPrivateApiContext";
}
function useGridPrivateApiContext() {
  const privateApiRef = React63.useContext(GridPrivateApiContext);
...
var useGridVirtualScroller = () => {
  ...
  const [panels, setPanels] = React66.useState(EMPTY_DETAIL_PANELS);
  const isRtl = useRtl();
  ...
  const scrollbarVerticalRef = React66.useRef(null);
  const scrollbarHorizontalRef = React66.useRef(null);
  const contentHeight = dimensions.contentSize.height;
  const columnsTotalWidth = dimensions.columnsTotalWidth;
  const hasColSpan = useGridSelector(apiRef, gridHasColSpanSelector);
  useResizeObserver(mainRef, () => apiRef.current.resize());
  const scrollPosition = React66.useRef(EMPTY_SCROLL_POSITION);
  const previousContextScrollPosition = React66.useRef(EMPTY_SCROLL_POSITION);
  const previousRowContext = React66.useRef(EMPTY_RENDER_CONTEXT);
  const renderContext = useGridSelector(apiRef, gridRenderContextSelector);
  const scrollTimeout = useTimeout();
  const frozenContext = React66.useRef(void 0);
  ...
  const focusedCell = {
    rowIndex: React66.useMemo(() => cellFocus ? currentPage.rows.findIndex((row) => row.id === cellFocus.id) : -1, [cellFocus, currentPage.rows]),
    columnIndex: React66.useMemo(() => cellFocus ? visibleColumns.findIndex((column) => column.field === cellFocus.field) : -1, [cellFocus, visibleColumns])
  };
  const updateRenderContext = React66.useCallback((nextRenderContext) => {
  ...
  const getRows = (params = {}) => {
    ...
    rowIndexes.forEach((rowIndexInPage) => {
      ...
      rows.push((0, import_jsx_runtime31.jsx)(rootProps.slots.row, _extends({
        row: model,
        rowId: id,
        index: rowIndex,
        selected: isSelected,
...
function GridOverlayWrapper(props) {
  ...
  return (0, import_jsx_runtime32.jsx)(GridOverlayWrapperRoot, _extends({
    className: clsx_default(classes2.root)
  }, props, {
    children: (0, import_jsx_runtime32.jsx)(GridOverlayWrapperInner, _extends({
...
true ? GridOverlays.propTypes = {
  ...
  // | To update them edit the TypeScript types and run "pnpm proptypes"  |
  // ----------------------------------------------------------------------
  loadingOverlayVariant: import_prop_types36.default.oneOf(["circular-progress", "linear-progress", "skeleton"]),
  overlayType: import_prop_types36.default.oneOf(["loadingOverlay", "noResultsOverlay", "noRowsOverlay"])
} : void 0;
function GridOverlays(props) {
  ...
  return (0, import_jsx_runtime32.jsx)(GridOverlayWrapper, _extends({}, props, {
    children: (0, import_jsx_runtime32.jsx)(Overlay, _extends({}, overlayProps))
  }));
}
...
function GridHeaders() {
  ...
  return (0, import_jsx_runtime33.jsx)(rootProps.slots.columnHeaders, _extends({
...
var GridConfigurationContext = React69.createContext(void 0);
if (true) {
...
var useGridConfiguration = () => {
  const configuration2 = React70.useContext(GridConfigurationContext);
...
var GridMainContainer = React71.forwardRef((props, ref) => {
  const rootProps = useGridRootProps();
  const configuration2 = useGridConfiguration();
  const ariaAttributes = configuration2.hooks.useGridAriaAttributes();
  return (0, import_jsx_runtime34.jsxs)(Element, _extends({
    ref,
    ownerState: rootProps,
    className: props.className,
    tabIndex: -1
  }, ariaAttributes, {
    children: [(0, import_jsx_runtime34.jsx)(GridPanelAnchor, {
      role: "presentation",
...
function GridTopContainer(props) {
  ...
  return (0, import_jsx_runtime35.jsx)(Element2, _extends({}, props, {
...
function GridBottomContainer(props) {
  ...
  return (0, import_jsx_runtime36.jsx)(Element3, _extends({}, props, {
...
var GridVirtualScrollerContent = React74.forwardRef(function GridVirtualScrollerContent2(props, ref) {
  var _a;
  const rootProps = useGridRootProps();
  ...
  return (0, import_jsx_runtime37.jsx)(VirtualScrollerContentRoot, _extends({
    ref
  }, props, {
    ownerState: rootProps,
...
function GridVirtualScrollerFiller({
  ...
  return (0, import_jsx_runtime38.jsxs)(Filler, {
    ...
    children: [leftPinnedWidth > 0 && (0, import_jsx_runtime38.jsx)(PinnedLeft, {
      className: gridClasses2["filler--pinnedLeft"],
      style: {
        width: leftPinnedWidth
      }
    }), (0, import_jsx_runtime38.jsx)(Main, {}), rightPinnedWidth > 0 && (0, import_jsx_runtime38.jsx)(PinnedRight, {
...
var GridVirtualScrollerRenderZone = React76.forwardRef(function GridVirtualScrollerRenderZone2(props, ref) {
  const {
    className
  ...
  return (0, import_jsx_runtime39.jsx)(VirtualScrollerRenderZoneRoot, _extends({
    ref,
    className: clsx_default(classes2.root, className),
    ownerState: rootProps,
    style: {
...
var GridVirtualScrollbar = React77.forwardRef(function GridVirtualScrollbar2(props, ref) {
  const apiRef = useGridPrivateApiContext();
  const rootProps = useGridRootProps();
  const isLocked = React77.useRef(false);
  const lastPosition = React77.useRef(0);
  const scrollbarRef = React77.useRef(null);
  ...
  return (0, import_jsx_runtime40.jsx)(Container2, {
    ref: useForkRef(ref, scrollbarRef),
    className: classes2.root,
    tabIndex: -1,
    "aria-hidden": "true",
    children: (0, import_jsx_runtime40.jsx)(Content, {
      ref: contentRef,
...
function GridVirtualScroller(props) {
  ...
  const rows = getRows();
  return (0, import_jsx_runtime41.jsxs)(GridMainContainer, _extends({
    className: classes2.root
  }, getContainerProps(), {
    children: [(0, import_jsx_runtime41.jsx)(GridScrollArea, {
      scrollDirection: "left"
    }), (0, import_jsx_runtime41.jsx)(GridScrollArea, {
      scrollDirection: "right"
    }), (0, import_jsx_runtime41.jsxs)(Scroller, _extends({
      className: classes2.scroller
    }, getScrollerProps(), {
      ownerState: rootProps,
      children: [(0, import_jsx_runtime41.jsxs)(GridTopContainer, {
        children: [(0, import_jsx_runtime41.jsx)(MemoizedGridHeaders, {}), (0, import_jsx_runtime41.jsx)(rootProps.slots.pinnedRows, {
          position: "top",
          virtualScroller
        })]
      }), (0, import_jsx_runtime41.jsx)(GridOverlays, _extends({}, overlaysProps)), (0, import_jsx_runtime41.jsx)(GridVirtualScrollerContent, _extends({}, getContentProps(), {
        children: (0, import_jsx_runtime41.jsxs)(GridVirtualScrollerRenderZone, _extends({}, getRenderZoneProps(), {
          children: [rows, (0, import_jsx_runtime41.jsx)(rootProps.slots.detailPanels, {
            virtualScroller
          })]
        }))
      })), (0, import_jsx_runtime41.jsx)(Memoized, {
        rowsLength: rows.length
      }), (0, import_jsx_runtime41.jsx)(GridBottomContainer, {
        children: (0, import_jsx_runtime41.jsx)(rootProps.slots.pinnedRows, {
          position: "bottom",
          virtualScroller
        })
      })]
    })), dimensions.hasScrollY && (0, import_jsx_runtime41.jsx)(GridVirtualScrollbar, _extends({
      position: "vertical"
    }, getScrollbarVerticalProps())), dimensions.hasScrollX && (0, import_jsx_runtime41.jsx)(GridVirtualScrollbar, _extends({
      position: "horizontal"
...
function GridFooterPlaceholder() {
  ...
  return (0, import_jsx_runtime42.jsx)(rootProps.slots.footer, _extends(
    {},
...
function useGridParamsApi(apiRef) {
  const getColumnHeaderParams = React80.useCallback((field) => ({
    field,
    colDef: apiRef.current.getColumn(field)
  }), [apiRef]);
  const getRowParams = React80.useCallback((id) => {
  ...
  const getCellParams = React80.useCallback((id, field) => {
  ...
  const getCellValue2 = React80.useCallback((id, field) => {
    const colDef = apiRef.current.getColumn(field);
    const row = apiRef.current.getRow(id);
    if (!row) {
      throw new MissingRowIdError(`No row with id #${id} found`);
  ...
  const getRowValue = React80.useCallback((row, colDef) => {
  ...
  const getRowFormattedValue = React80.useCallback((row, colDef) => {
  ...
  const getColumnHeaderElement = React80.useCallback((field) => {
    if (!apiRef.current.rootElementRef.current) {
      return null;
    }
    return getGridColumnHeaderElement(apiRef.current.rootElementRef.current, field);
  }, [apiRef]);
  const getRowElement = React80.useCallback((id) => {
    if (!apiRef.current.rootElementRef.current) {
      return null;
    }
    return getGridRowElement(apiRef.current.rootElementRef.current, id);
  }, [apiRef]);
  const getCellElement = React80.useCallback((id, field) => {
    if (!apiRef.current.rootElementRef.current) {
      return null;
    }
...
var GridCell = React81.forwardRef(function GridCell2(props, ref) {
  var _a, _b, _c;
  const {
    column,
    rowId,
  ...
  const cellRef = React81.useRef(null);
  const handleRef = useForkRef(ref, cellRef);
  const focusElementRef = React81.useRef(null);
  ...
  const publishMouseUp = React81.useCallback((eventName) => (event) => {
  ...
  const publishMouseDown = React81.useCallback((eventName) => (event) => {
    const params = apiRef.current.getCellParams(rowId, field || "");
    apiRef.current.publishEvent(eventName, params, event);
    if (onMouseDown) {
      onMouseDown(event);
  ...
  if (React81.isValidElement(children) && canManageOwnFocus) {
...
true ? GridCell.propTypes = {
  ...
  // | To update them edit the TypeScript types and run "pnpm proptypes"  |
  // ----------------------------------------------------------------------
  align: import_prop_types37.default.oneOf(["center", "left", "right"]).isRequired,
  className: import_prop_types37.default.string,
  colIndex: import_prop_types37.default.number.isRequired,
  colSpan: import_prop_types37.default.number,
  column: import_prop_types37.default.object.isRequired,
  disableDragEvents: import_prop_types37.default.bool,
  editCellState: import_prop_types37.default.shape({
    changeReason: import_prop_types37.default.oneOf(["debouncedSetEditCellValue", "setEditCellValue"]),
    isProcessingProps: import_prop_types37.default.bool,
    isValidating: import_prop_types37.default.bool,
    value: import_prop_types37.default.any
  }),
  gridHasFiller: import_prop_types37.default.bool.isRequired,
  isNotVisible: import_prop_types37.default.bool.isRequired,
  onClick: import_prop_types37.default.func,
  onDoubleClick: import_prop_types37.default.func,
  onDragEnter: import_prop_types37.default.func,
  onDragOver: import_prop_types37.default.func,
  ...
  pinnedOffset: import_prop_types37.default.number.isRequired,
  pinnedPosition: import_prop_types37.default.oneOf([0, 1, 2, 3]).isRequired,
  rowId: import_prop_types37.default.oneOfType([import_prop_types37.default.number, import_prop_types37.default.string]).isRequired,
  sectionIndex: import_prop_types37.default.number.isRequired,
  sectionLength: import_prop_types37.default.number.isRequired,
...
var GridActionsCellItem = React82.forwardRef((props, ref) => {
  var _a;
  const rootProps = useGridRootProps();
  if (!props.showInMenu) {
    const {
    ...
    return (0, import_jsx_runtime44.jsx)(rootProps.slots.baseIconButton, _extends({
      ref,
      size: "small",
      role: "menuitem",
      "aria-label": label2
      ...
      children: React82.cloneElement(icon2, {
        fontSize: "small"
      })
    }));
  }
  ...
  return (0, import_jsx_runtime44.jsxs)(MenuItem_default, _extends({
    ref
  }, other, {
    onClick: handleClick,
    children: [icon && (0, import_jsx_runtime44.jsx)(ListItemIcon_default, {
      children: icon
    }), label]
  }));
});
true ? GridActionsCellItem.propTypes = {
  ...
  showInMenu: import_prop_types38.default.bool
} : void 0;
...
function GridSkeletonCell(props) {
  ...
  const skeletonProps = React83.useMemo(() => {
  ...
  return (0, import_jsx_runtime45.jsx)("div", _extends({
    ...
    children: !empty && (0, import_jsx_runtime45.jsx)(Skeleton_default, _extends({}, skeletonProps))
  }));
}
true ? GridSkeletonCell.propTypes = {
  ...
  // | To update them edit the TypeScript types and run "pnpm proptypes"  |
  // ----------------------------------------------------------------------
  align: import_prop_types39.default.string,
  /**
   * If `true`, the cell will not display the skeleton but still reserve the cell space.
   * @default false
   */
  empty: import_prop_types39.default.bool,
  field: import_prop_types39.default.string,
  height: import_prop_types39.default.oneOfType([import_prop_types39.default.oneOf(["auto"]), import_prop_types39.default.number]),
  type: import_prop_types39.default.oneOf(["actions", "boolean", "custom", "date", "dateTime", "number", "singleSelect", "string"]),
...
var GridRoot = React84.forwardRef(function GridRoot2(props, ref) {
  const rootProps = useGridRootProps();
  const {
    className
  ...
  return (0, import_jsx_runtime46.jsx)(GridRootStyles, _extends({
    ref: handleRef,
    className: clsx_default(className, classes2.root),
    ownerState
  }, other));
...
var GridFooterContainer = React85.forwardRef(function GridFooterContainer2(props, ref) {
  const {
    className
  } = props, other = _objectWithoutPropertiesLoose(props, _excluded21);
  const rootProps = useGridRootProps();
  const classes2 = useUtilityClasses20(rootProps);
  return (0, import_jsx_runtime47.jsx)(GridFooterContainerRoot, _extends({
    ref,
    className: clsx_default(classes2.root, className),
    ownerState: rootProps
  }, other));
...
var GridOverlay = React86.forwardRef(function GridOverlay2(props, ref) {
  const {
    className
  } = props, other = _objectWithoutPropertiesLoose(props, _excluded27);
  const rootProps = useGridRootProps();
  const classes2 = useUtilityClasses21(rootProps);
  return (0, import_jsx_runtime48.jsx)(GridOverlayRoot, _extends({
    ref,
    className: clsx_default(classes2.root, className),
    ownerState: rootProps
  }, other));
...
var GridToolbarContainer = React87.forwardRef(function GridToolbarContainer2(props, ref) {
  const {
    className,
    children
  ...
  return (0, import_jsx_runtime49.jsx)(GridToolbarContainerRoot, _extends({
    ref,
    className: clsx_default(className, classes2.root),
    ownerState: rootProps
  }, other, {
...
var ColumnHeaderMenuIcon = React88.memo((props) => {
  var _a, _b;
  const {
    colDef,
    open,
  ...
  const handleMenuIconClick = React88.useCallback((event) => {
    event.preventDefault();
    event.stopPropagation();
...
function GridColumnHeaderMenu({
  ...
  return (0, import_jsx_runtime51.jsx)(GridMenu, {
    placement: `bottom-${colDef.align === "right" ? "start" : "end"}`,
    open,
    target,
    onClose: hideMenu,
    onExited,
    children: (0, import_jsx_runtime51.jsx)(ContentComponent, _extends({
      colDef,
      hideMenu,
      open,
      id: columnMenuId,
...
var ColumnHeaderInnerTitle = React90.forwardRef(function ColumnHeaderInnerTitle2(props, ref) {
  const {
    className
  } = props, other = _objectWithoutPropertiesLoose(props, _excluded29);
  const rootProps = useGridRootProps();
  const classes2 = useUtilityClasses24(rootProps);
  return (0, import_jsx_runtime52.jsx)(GridColumnHeaderTitleRoot, _extends({
    ref,
    className: clsx_default(classes2.root, className),
    ownerState: rootProps
  }, other));
...
function GridColumnHeaderTitle(props) {
  ...
  const rootProps = useGridRootProps();
  const titleRef = React90.useRef(null);
  const [tooltip, setTooltip] = React90.useState("");
  const handleMouseOver = React90.useCallback(() => {
  ...
  return (0, import_jsx_runtime52.jsx)(rootProps.slots.baseTooltip, _extends({
    title: description || tooltip
  }, (_a = rootProps.slotProps) == null ? void 0 : _a.baseTooltip, {
    children: (0, import_jsx_runtime52.jsx)(ColumnHeaderInnerTitle, {
...
function GridColumnHeaderSeparatorRaw(props) {
  ...
  const stopClick = React91.useCallback((event) => {
    event.preventDefault();
    event.stopPropagation();
  }, []);
  return (
    // eslint-disable-next-line jsx-a11y/click-events-have-key-events,jsx-a11y/no-static-element-interactions
    (0, import_jsx_runtime53.jsx)("div", _extends({
      className: classes2.root,
      style: {
        minHeight: height2
      }
      ...
      onClick: stopClick,
      children: (0, import_jsx_runtime53.jsx)(rootProps.slots.columnResizeIcon, {
        className: classes2.icon
      })
    }))
  );
}
var GridColumnHeaderSeparator = React91.memo(GridColumnHeaderSeparatorRaw);
...
var GridGenericColumnHeaderItem = React92.forwardRef(function GridGenericColumnHeaderItem2(props, ref) {
  const {
    classes: classes2,
    colIndex,
    height: height2,
  ...
  const apiRef = useGridPrivateApiContext();
  const rootProps = useGridRootProps();
  const headerCellRef = React92.useRef(null);
  ...
  return (0, import_jsx_runtime54.jsxs)("div", _extends({
    ...
    children: [(0, import_jsx_runtime54.jsxs)("div", _extends({
      className: classes2.draggableContainer,
      draggable: isDraggable,
      role: "presentation"
    }, draggableContainerProps, {
      children: [(0, import_jsx_runtime54.jsxs)("div", {
        className: classes2.titleContainer,
        role: "presentation",
        children: [(0, import_jsx_runtime54.jsx)("div", {
          className: classes2.titleContainerContent,
          children: headerComponent !== void 0 ? headerComponent : (0, import_jsx_runtime54.jsx)(GridColumnHeaderTitle, {
            label,
            description,
            columnWidth: width2
          })
    ...
    })), (0, import_jsx_runtime54.jsx)(GridColumnHeaderSeparator, _extends({
...
function GridColumnHeaderItem(props) {
  ...
  const apiRef = useGridPrivateApiContext();
  const rootProps = useGridRootProps();
  const headerCellRef = React93.useRef(null);
  const columnMenuId = useId();
  const columnMenuButtonId = useId();
  const iconButtonRef = React93.useRef(null);
  const [showColumnMenuIcon, setShowColumnMenuIcon] = React93.useState(columnMenuOpen);
  const isDraggable = React93.useMemo(() => !rootProps.disableColumnReorder && !disableReorder && !colDef.disableReorder, [rootProps.disableColumnReorder, disableReorder, colDef.disableReorder]);
  let headerComponent;
  ...
  const publish = React93.useCallback((eventName) => (event) => {
    if (isEventTargetInPortal(event)) {
      return;
    }
    apiRef.current.publishEvent(eventName, apiRef.current.getColumnHeaderParams(colDef.field), event);
  }, [apiRef, colDef.field]);
  const mouseEventsHandlers = React93.useMemo(() => ({
  ...
  const draggableEventHandlers = React93.useMemo(() => isDraggable ? {
    onDragStart: publish("columnHeaderDragStart"),
    onDragEnter: publish("columnHeaderDragEnter"),
    onDragOver: publish("columnHeaderDragOver"),
    onDragEnd: publish("columnHeaderDragEnd")
  } : {}, [isDraggable, publish]);
  const columnHeaderSeparatorProps = React93.useMemo(() => ({
  ...
  const handleExited = React93.useCallback(() => {
    setShowColumnMenuIcon(false);
  }, []);
  const columnMenuIconButton = !rootProps.disableColumnMenu && !colDef.disableColumnMenu && (0, import_jsx_runtime55.jsx)(ColumnHeaderMenuIcon, {
    colDef,
    columnMenuId,
    columnMenuButtonId,
  ...
  const columnMenu = (0, import_jsx_runtime55.jsx)(GridColumnHeaderMenu, {
    columnMenuId,
    columnMenuButtonId,
    field: colDef.field,
    open: columnMenuOpen,
  ...
  const columnTitleIconButtons = (0, import_jsx_runtime55.jsxs)(React93.Fragment, {
    children: [!rootProps.disableColumnFilter && (0, import_jsx_runtime55.jsx)(rootProps.slots.columnHeaderFilterIconButton, _extends({
      field: colDef.field,
      counter: filterItemsCounter
    }, (_b = rootProps.slotProps) == null ? void 0 : _b.columnHeaderFilterIconButton)), showSortIcon && (0, import_jsx_runtime55.jsx)(rootProps.slots.columnHeaderSortIcon, _extends({
      field: colDef.field,
  ...
  return (0, import_jsx_runtime55.jsx)(GridGenericColumnHeaderItem, _extends({
    ref: headerCellRef,
    classes: classes2,
    columnMenuOpen,
    colIndex,
...
true ? GridColumnHeaderItem.propTypes = {
  ...
  gridHasFiller: import_prop_types47.default.bool.isRequired,
  hasFocus: import_prop_types47.default.bool,
  headerHeight: import_prop_types47.default.number.isRequired,
  indexInSection: import_prop_types47.default.number.isRequired,
  ...
  pinnedPosition: import_prop_types47.default.oneOf(["left", "right"]),
  sectionLength: import_prop_types47.default.number.isRequired,
...
var GridIconButtonContainer = React94.forwardRef(function GridIconButtonContainer2(props, ref) {
  const {
    className
  } = props, other = _objectWithoutPropertiesLoose(props, _excluded32);
  const rootProps = useGridRootProps();
  const classes2 = useUtilityClasses27(rootProps);
  return (0, import_jsx_runtime56.jsx)(GridIconButtonContainerRoot, _extends({
    ref,
    className: clsx_default(classes2.root, className),
    ownerState: rootProps
  }, other));
...
function getIcon(icons, direction, className, sortingOrder) {
  ...
  return Icon ? (0, import_jsx_runtime57.jsx)(Icon, _extends({
    fontSize: "small",
    className
  }, iconProps)) : null;
}
function GridColumnHeaderSortIconRaw(props) {
  ...
  return (0, import_jsx_runtime57.jsxs)(GridIconButtonContainer, {
    children: [index != null && (0, import_jsx_runtime57.jsx)(Badge_default, {
      badgeContent: index,
      color: "default",
      overlap: "circular",
      children: iconButton
...
var GridColumnHeaderSortIcon = React95.memo(GridColumnHeaderSortIconRaw);
...
function GridColumnHeaderFilterIconButton(props) {
  ...
  const labelId = useId();
  const panelId = useId();
  const toggleFilter = React96.useCallback((event) => {
    event.preventDefault();
    event.stopPropagation();
    const {
      open: open2,
  ...
  const iconButton = (0, import_jsx_runtime58.jsx)(rootProps.slots.baseIconButton, _extends({
    ...
    children: (0, import_jsx_runtime58.jsx)(rootProps.slots.columnFilteredIcon, {
      className: classes2.icon,
      fontSize: "small"
    })
  }));
  return (0, import_jsx_runtime58.jsx)(rootProps.slots.baseTooltip, _extends({
    title: apiRef.current.getLocaleText("columnHeaderFiltersTooltipActive")(counter),
    enterDelay: 1e3
  }, (_b = rootProps.slotProps) == null ? void 0 : _b.baseTooltip, {
    children: (0, import_jsx_runtime58.jsxs)(GridIconButtonContainer, {
      children: [counter > 1 && (0, import_jsx_runtime58.jsx)(Badge_default, {
...
true ? GridColumnHeaderFilterIconButton.propTypes = {
  ...
  // | To update them edit the TypeScript types and run "pnpm proptypes"  |
  // ----------------------------------------------------------------------
  counter: import_prop_types49.default.number,
...
var GridSeparatorIcon = createSvgIcon((0, import_jsx_runtime59.jsx)("rect", {
  width: "1",
  height: "24",
  x: "11.5",
  rx: "0.5"
...
var GridColumnMenuContainer = React98.forwardRef(function GridColumnMenuContainer2(props, ref) {
  const {
    hideMenu,
    id,
    labelledby,
  ...
  const handleListKeyDown = React98.useCallback((event) => {
    if (event.key === "Tab") {
      event.preventDefault();
    }
...
true ? GridColumnMenuContainer.propTypes = {
  ...
  hideMenu: import_prop_types50.default.func.isRequired,
  id: import_prop_types50.default.string,
  labelledby: import_prop_types50.default.string,
...
var useGridColumnMenuSlots = (props) => {
  ...
  const processedComponents = React99.useMemo(() => _extends({}, defaultSlots2, slots), [defaultSlots2, slots]);
  const processedSlotProps = React99.useMemo(() => {
  ...
  const userItems = React99.useMemo(() => {
...
function GridColumnMenuHideItem(props) {
  ...
  const toggleColumn = React100.useCallback((event) => {
    if (disabled) {
      return;
    }
...
function GridColumnMenuManageItem(props) {
  ...
  const apiRef = useGridApiContext();
  const rootProps = useGridRootProps();
  const showColumns = React101.useCallback((event) => {
    onClick(event);
  ...
  return (0, import_jsx_runtime62.jsxs)(MenuItem_default, {
    ...
    children: [(0, import_jsx_runtime62.jsx)(ListItemIcon_default, {
      children: (0, import_jsx_runtime62.jsx)(rootProps.slots.columnMenuManageColumnsIcon, {
        fontSize: "small"
      })
...
function GridColumnMenuColumnsItem(props) {
  return (0, import_jsx_runtime63.jsxs)(React102.Fragment, {
...
function GridColumnMenuFilterItem(props) {
  ...
  const apiRef = useGridApiContext();
  const rootProps = useGridRootProps();
  const showFilter = React103.useCallback((event) => {
    onClick(event);
  ...
  return (0, import_jsx_runtime64.jsxs)(MenuItem_default, {
    ...
    children: [(0, import_jsx_runtime64.jsx)(ListItemIcon_default, {
      children: (0, import_jsx_runtime64.jsx)(rootProps.slots.columnMenuFilterIcon, {
        fontSize: "small"
      })
...
function GridColumnMenuSortItem(props) {
  ...
  const rootProps = useGridRootProps();
  const sortDirection = React104.useMemo(() => {
    if (!colDef) {
      return null;
    }
  ...
  const sortingOrder = colDef.sortingOrder ?? rootProps.sortingOrder;
  const onSortMenuItemClick = React104.useCallback((event) => {
    onClick(event);
  ...
  return (0, import_jsx_runtime65.jsxs)(React104.Fragment, {
    children: [sortingOrder.includes("asc") && sortDirection !== "asc" ? (0, import_jsx_runtime65.jsxs)(MenuItem_default, {
      onClick: onSortMenuItemClick,
      "data-value": "asc",
      children: [(0, import_jsx_runtime65.jsx)(ListItemIcon_default, {
        children: (0, import_jsx_runtime65.jsx)(rootProps.slots.columnMenuSortAscendingIcon, {
          fontSize: "small"
        })
      }), (0, import_jsx_runtime65.jsx)(ListItemText_default, {
        children: getLabel("columnMenuSortAsc")
      })]
    }) : null, sortingOrder.includes("desc") && sortDirection !== "desc" ? (0, import_jsx_runtime65.jsxs)(MenuItem_default, {
      onClick: onSortMenuItemClick,
      "data-value": "desc",
      children: [(0, import_jsx_runtime65.jsx)(ListItemIcon_default, {
        children: (0, import_jsx_runtime65.jsx)(rootProps.slots.columnMenuSortDescendingIcon, {
          fontSize: "small"
        })
      }), (0, import_jsx_runtime65.jsx)(ListItemText_default, {
        children: getLabel("columnMenuSortDesc")
      })]
    }) : null, sortingOrder.includes(null) && sortDirection != null ? (0, import_jsx_runtime65.jsxs)(MenuItem_default, {
      onClick: onSortMenuItemClick,
      children: [(0, import_jsx_runtime65.jsx)(ListItemIcon_default, {}), (0, import_jsx_runtime65.jsx)(ListItemText_default, {
...
var GridGenericColumnMenu = React105.forwardRef(function GridGenericColumnMenu2(props, ref) {
  const {
    defaultSlots: defaultSlots2,
    defaultSlotProps,
    slots,
  ...
  return (0, import_jsx_runtime66.jsx)(GridColumnMenuContainer, _extends({
    ref
  }, other, {
    children: orderedSlots.map(([Component, otherProps], index) => (0, import_jsx_runtime66.jsx)(Component, _extends({}, otherProps), index))
  }));
});
var GridColumnMenu = React105.forwardRef(function GridColumnMenu2(props, ref) {
  return (0, import_jsx_runtime66.jsx)(GridGenericColumnMenu, _extends({}, props, {
    ref,
...
true ? GridColumnMenu.propTypes = {
  ...
  hideMenu: import_prop_types56.default.func.isRequired,
  id: import_prop_types56.default.string,
  labelledby: import_prop_types56.default.string,
...
var isEnabled = () => true;
var GridPanelWrapper = React106.forwardRef(function GridPanelWrapper2(props, ref) {
  const {
    className,
    slotProps = {}
  ...
  return (0, import_jsx_runtime67.jsx)(FocusTrap_default, _extends({
    open: true,
    disableEnforceFocus: true,
    isEnabled
  }, slotProps.TrapFocus, {
    children: (0, import_jsx_runtime67.jsx)(GridPanelWrapperRoot, _extends({
      ref,
      tabIndex: -1,
      className: clsx_default(className, classes2.root),
      ownerState: rootProps
...
function GridColumnsManagement(props) {
  var _a, _b, _c;
  const apiRef = useGridApiContext();
  const searchInputRef = React107.useRef(null);
  ...
  const rootProps = useGridRootProps();
  const [searchValue, setSearchValue] = React107.useState("");
  ...
  const isResetDisabled = React107.useMemo(() => checkColumnVisibilityModelsSame(columnVisibilityModel, initialColumnVisibilityModel), [columnVisibilityModel, initialColumnVisibilityModel]);
  const sortedColumns = React107.useMemo(() => {
    switch (sort) {
      case "asc":
  ...
  const currentColumns = React107.useMemo(() => {
  ...
  const toggleAllColumns = React107.useCallback((isVisible) => {
  ...
  const handleSearchValueChange = React107.useCallback((event) => {
    setSearchValue(event.target.value);
  }, []);
  const hideableColumns = React107.useMemo(() => currentColumns.filter((col) => col.hideable), [currentColumns]);
  const allHideableColumnsVisible = React107.useMemo(() => hideableColumns.every((column) => columnVisibilityModel[column.field] == null || columnVisibilityModel[column.field] !== false), [columnVisibilityModel, hideableColumns]);
  const allHideableColumnsHidden = React107.useMemo(() => hideableColumns.every((column) => columnVisibilityModel[column.field] === false), [columnVisibilityModel, hideableColumns]);
  const firstSwitchRef = React107.useRef(null);
  React107.useEffect(() => {
  ...
  return (0, import_jsx_runtime68.jsxs)(React107.Fragment, {
    children: [(0, import_jsx_runtime68.jsx)(GridColumnsManagementHeader, {
      className: classes2.header,
      ownerState: rootProps,
      children: (0, import_jsx_runtime68.jsx)(rootProps.slots.baseTextField, _extends({
        ...
        size: "small",
        InputProps: {
          startAdornment: (0, import_jsx_runtime68.jsx)(rootProps.slots.baseInputAdornment, {
            position: "start",
            children: (0, import_jsx_runtime68.jsx)(rootProps.slots.quickFilterIcon, {})
          }),
          sx: {
            pl: 1.5
          }
    ...
    }), (0, import_jsx_runtime68.jsxs)(GridColumnsManagementBody, {
      className: classes2.root,
      ownerState: rootProps,
      children: [currentColumns.map((column) => {
        var _a2;
        return (0, import_jsx_runtime68.jsx)(FormControlLabel_default, {
          className: classes2.row,
          control: (0, import_jsx_runtime68.jsx)(rootProps.slots.baseCheckbox, _extends({
      ...
      }), currentColumns.length === 0 && (0, import_jsx_runtime68.jsx)(GridColumnsManagementEmptyText, {
        ownerState: rootProps,
        children: apiRef.current.getLocaleText("columnsManagementNoColumns")
      })]
    }), (!disableShowHideToggle || !disableResetButton) && currentColumns.length > 0 ? (0, import_jsx_runtime68.jsxs)(GridColumnsManagementFooter, {
      ownerState: rootProps,
      className: classes2.footer,
      children: [!disableShowHideToggle ? (0, import_jsx_runtime68.jsx)(FormControlLabel_default, {
        control: (0, import_jsx_runtime68.jsx)(rootProps.slots.baseCheckbox, _extends({
      ...
      }) : (0, import_jsx_runtime68.jsx)("span", {}), !disableResetButton ? (0, import_jsx_runtime68.jsx)(rootProps.slots.baseButton, _extends({
...
true ? GridColumnsManagement.propTypes = {
   ...
   * @default true
   */
  autoFocusSearchField: import_prop_types58.default.bool,
  /**
   * If `true`, the `Reset` button will not be disabled
   * @default false
   */
  disableResetButton: import_prop_types58.default.bool,
  /**
   * If `true`, the `Show/Hide all` toggle checkbox will not be displayed.
   * @default false
   */
  disableShowHideToggle: import_prop_types58.default.bool,
  /**
   ...
   */
  getTogglableColumns: import_prop_types58.default.func,
  searchPredicate: import_prop_types58.default.func,
   ...
   * @default 'all'
   */
  toggleAllMode: import_prop_types58.default.oneOf(["all", "filteredOnly"])
} : void 0;
...
function GridColumnsPanel(props) {
  var _a;
  const rootProps = useGridRootProps();
  return (0, import_jsx_runtime69.jsx)(GridPanelWrapper, _extends({}, props, {
    children: (0, import_jsx_runtime69.jsx)(GridColumnsManagement, _extends({}, (_a = rootProps.slotProps) == null ? void 0 : _a.columnsManagement))
  }));
}
...
var GridPanel = React109.forwardRef((props, ref) => {
  const {
    children,
    className
  ...
  const [anchorEl, setAnchorEl] = React109.useState(null);
  React109.useEffect(() => {
    var _a, _b;
  ...
  return (0, import_jsx_runtime70.jsx)(GridPanelRoot, _extends({
    ref,
    ...
    children: (0, import_jsx_runtime70.jsx)(ClickAwayListener, {
      mouseEvent: "onMouseUp",
      onClickAway: handleClickAway,
      children: (0, import_jsx_runtime70.jsx)(GridPaperRoot, {
...
true ? GridPanel.propTypes = {
  ...
  ownerState: import_prop_types60.default.object
} : void 0;
...
function GridPanelContent(props) {
  ...
  return (0, import_jsx_runtime71.jsx)(GridPanelContentRoot, _extends({
    className: clsx_default(className, classes2.root),
    ownerState: rootProps
  }, other));
}
...
function GridPanelFooter(props) {
  ...
  return (0, import_jsx_runtime72.jsx)(GridPanelFooterRoot, _extends({
    className: clsx_default(className, classes2.root),
    ownerState: rootProps
  }, other));
}
...
function GridPanelHeader(props) {
  ...
  return (0, import_jsx_runtime73.jsx)(GridPanelHeaderRoot, _extends({
    className: clsx_default(className, classes2.root),
    ownerState: rootProps
  }, other));
}
...
var GridFilterForm = React113.forwardRef(function GridFilterForm2(props, ref) {
  ...
  const valueRef = React113.useRef(null);
  const filterSelectorRef = React113.useRef(null);
  ...
  const sortedFilteredColumns = React113.useMemo(() => {
    switch (columnsSort) {
      case "asc":
  ...
  const currentOperator = React113.useMemo(() => {
    var _a2;
  ...
  const changeColumn = React113.useCallback((event) => {
  ...
  const changeOperator = React113.useCallback((event) => {
  ...
  const changeLogicOperator = React113.useCallback((event) => {
  ...
  React113.useImperativeHandle(focusElementRef, () => ({
    focus: () => {
      var _a2;
  ...
  return (0, import_jsx_runtime74.jsxs)(GridFilterFormRoot, _extends({
    ...
    children: [(0, import_jsx_runtime74.jsx)(FilterFormDeleteIcon, _extends({
      variant: "standard",
      as: rootProps.slots.baseFormControl
    }, baseFormControlProps, deleteIconProps, {
      className: clsx_default(classes2.deleteIcon, baseFormControlProps.className, deleteIconProps.className),
      ownerState: rootProps,
      children: (0, import_jsx_runtime74.jsx)(rootProps.slots.baseIconButton, _extends({
        ...
        children: (0, import_jsx_runtime74.jsx)(rootProps.slots.filterPanelDeleteIcon, {
          fontSize: "small"
        })
      }))
    })), (0, import_jsx_runtime74.jsx)(FilterFormLogicOperatorInput, _extends({
      variant: "standard",
      as: rootProps.slots.baseFormControl
      ...
      ownerState: rootProps,
      children: (0, import_jsx_runtime74.jsx)(rootProps.slots.baseSelect, _extends({
        inputProps: {
      ...
      ownerState: rootProps,
      children: [(0, import_jsx_runtime74.jsx)(rootProps.slots.baseInputLabel, _extends({}, baseInputLabelProps, {
        htmlFor: columnSelectId,
        id: columnSelectLabelId,
        children: apiRef.current.getLocaleText("filterPanelColumns")
      })), (0, import_jsx_runtime74.jsx)(rootProps.slots.baseSelect, _extends({
    ...
    })), (0, import_jsx_runtime74.jsx)(FilterFormValueInput, _extends({
      variant: "standard",
      as: rootProps.slots.baseFormControl
    }, baseFormControlProps, valueInputPropsOther, {
      className: clsx_default(classes2.valueInput, baseFormControlProps.className, valueInputPropsOther.className),
      ownerState: rootProps,
      children: (currentOperator == null ? void 0 : currentOperator.InputComponent) ? (0, import_jsx_runtime74.jsx)(currentOperator.InputComponent, _extends({
        apiRef,
        item,
...
true ? GridFilterForm.propTypes = {
   ...
   */
  applyFilterChanges: import_prop_types64.default.func.isRequired,
  /**
   * Callback called when the logic operator is changed.
   * @param {GridLogicOperator} operator The new logic operator.
   */
  applyMultiFilterOperatorChanges: import_prop_types64.default.func.isRequired,
  /**
   * @ignore - do not document.
   */
   ...
   * @default {}
   */
  columnInputProps: import_prop_types64.default.any,
  /**
   * Changes how the options in the columns selector should be ordered.
   * If not specified, the order is derived from the `columns` prop.
   */
  columnsSort: import_prop_types64.default.oneOf(["asc", "desc"]),
  /**
   * Callback called when the delete button is clicked.
   * @param {GridFilterItem} item The deleted [[GridFilterItem]].
   */
  deleteFilter: import_prop_types64.default.func.isRequired,
  /**
   * Props passed to the delete icon.
   * @default {}
   */
  deleteIconProps: import_prop_types64.default.any,
  /**
   * If `true`, disables the logic operator field but still renders it.
   */
  disableMultiFilterOperator: import_prop_types64.default.bool,
  /**
   * Allows to filter the columns displayed in the filter form.
   * @param {FilterColumnsArgs} args The columns of the grid and name of field.
   * @returns {GridColDef['field'][]} The filtered fields array.
   */
  filterColumns: import_prop_types64.default.func,
  /**
   * A ref allowing to set imperative focus.
   * It can be passed to the el
   */
  focusElementRef: import_prop_types64.default.oneOfType([import_prop_types64.default.func, import_prop_types64.default.object]),
  /**
   * If `true`, the logic operator field is rendered.
   * The field will be invisible if `showMultiFilterOperators` is also `true`.
   */
  hasMultipleFilters: import_prop_types64.default.bool.isRequired,
  /**
   * The [[GridFilterItem]] representing this form.
   */
  item: import_prop_types64.default.shape({
   ...
   * @default {}
   */
  logicOperatorInputProps: import_prop_types64.default.any,
  /**
   * Sets the available logic operators.
   * @default [GridLogicOperator.And, GridLogicOperator.Or]
   */
  logicOperators: import_prop_types64.default.arrayOf(import_prop_types64.default.oneOf(["and", "or"]).isRequired),
  /**
   * Props passed to the operator input component.
   * @default {}
   */
  operatorInputProps: import_prop_types64.default.any,
  /**
   ...
   */
  showMultiFilterOperators: import_prop_types64.default.bool,
  /**
   * Props passed to the value input component.
   * @default {}
   */
  valueInputProps: import_prop_types64.default.any
} : void 0;
...
var GridFilterPanel = React114.forwardRef(function GridFilterPanel2(props, ref) {
  var _a, _b;
  const apiRef = useGridApiContext();
  const rootProps = useGridRootProps();
  const filterModel = useGridSelector(apiRef, gridFilterModelSelector);
  ...
  const lastFilterRef = React114.useRef(null);
  const placeholderFilter = React114.useRef(null);
  const {
    logicOperators = [GridLogicOperator.And, GridLogicOperator.Or],
    columnsSort,
    filterFormProps,
  ...
  const applyFilterLogicOperator = React114.useCallback((operator) => {
    apiRef.current.setFilterLogicOperator(operator);
  }, [apiRef]);
  const getDefaultFilter = React114.useCallback(() => {
  ...
  const getNewFilter = React114.useCallback(() => {
  ...
  const {
    readOnlyFilters,
    validFilters
  } = React114.useMemo(() => items.reduce((acc, item) => {
  ...
  const addNewFilter = React114.useCallback(() => {
  ...
  const deleteFilter = React114.useCallback((item) => {
  ...
  const handleRemoveAll = React114.useCallback(() => {
  ...
  return (0, import_jsx_runtime75.jsxs)(GridPanelWrapper, _extends({
    ref
  }, other, {
    children: [(0, import_jsx_runtime75.jsxs)(GridPanelContent, {
      children: [readOnlyFilters.map((item, index) => (0, import_jsx_runtime75.jsx)(GridFilterForm, _extends({
        item,
        ...
        logicOperators,
        columnsSort
      }, filterFormProps), item.id == null ? index : item.id)), validFilters.map((item, index) => (0, import_jsx_runtime75.jsx)(GridFilterForm, _extends({
        item,
        applyFilterChanges: applyFilter,
        deleteFilter,
        hasMultipleFilters,
    ...
    }), !rootProps.disableMultipleColumnsFiltering && !(disableAddFilterButton && disableRemoveAllButton) ? (0, import_jsx_runtime75.jsxs)(GridPanelFooter, {
      children: [!disableAddFilterButton ? (0, import_jsx_runtime75.jsx)(rootProps.slots.baseButton, _extends({
        onClick: addNewFilter,
        startIcon: (0, import_jsx_runtime75.jsx)(rootProps.slots.filterPanelAddIcon, {})
      }, (_a = rootProps.slotProps) == null ? void 0 : _a.baseButton, {
        children: apiRef.current.getLocaleText("filterPanelAddFilter")
      })) : (0, import_jsx_runtime75.jsx)("span", {}), !disableRemoveAllButton && validFilters.length > 0 ? (0, import_jsx_runtime75.jsx)(rootProps.slots.baseButton, _extends({
        onClick: handleRemoveAll,
        startIcon: (0, import_jsx_runtime75.jsx)(rootProps.slots.filterPanelRemoveAllIcon, {})
...
true ? GridFilterPanel.propTypes = {
   ...
   * @default false
   */
  disableAddFilterButton: import_prop_types65.default.bool,
  /**
   * If `true`, the `Remove all` button will be disabled
   * @default false
   */
  disableRemoveAllButton: import_prop_types65.default.bool,
  /**
   * Props passed to each filter form.
   */
  filterFormProps: import_prop_types65.default.shape({
   ...
   */
  getColumnForNewFilter: import_prop_types65.default.func,
  /**
   * Sets the available logic operators.
   * @default [GridLogicOperator.And, GridLogicOperator.Or]
   */
...
var GridToolbarColumnsButton = React115.forwardRef(function GridToolbarColumnsButton2(props, ref) {
  var _a, _b;
  const {
    slotProps = {}
  } = props;
  ...
  return (0, import_jsx_runtime76.jsx)(rootProps.slots.baseTooltip, _extends({
    ...
    children: (0, import_jsx_runtime76.jsx)(rootProps.slots.baseButton, _extends({
      ...
      startIcon: (0, import_jsx_runtime76.jsx)(rootProps.slots.columnSelectorIcon, {})
    }, buttonProps, {
      onClick: showColumns
    }, (_b = rootProps.slotProps) == null ? void 0 : _b.baseButton, {
...
var GridToolbarDensitySelector = React116.forwardRef(function GridToolbarDensitySelector2(props, ref) {
  var _a, _b;
  const {
    slotProps = {}
  } = props;
  ...
  const densityOptions = [{
    icon: (0, import_jsx_runtime77.jsx)(rootProps.slots.densityCompactIcon, {}),
    label: apiRef.current.getLocaleText("toolbarDensityCompact"),
    value: "compact"
  }, {
    icon: (0, import_jsx_runtime77.jsx)(rootProps.slots.densityStandardIcon, {}),
    label: apiRef.current.getLocaleText("toolbarDensityStandard"),
    value: "standard"
  }, {
    icon: (0, import_jsx_runtime77.jsx)(rootProps.slots.densityComfortableIcon, {}),
    label: apiRef.current.getLocaleText("toolbarDensityComfortable"),
    value: "comfortable"
  }];
  const startIcon = React116.useMemo(() => {
    switch (density) {
      case "compact":
        return (0, import_jsx_runtime77.jsx)(rootProps.slots.densityCompactIcon, {});
      case "comfortable":
        return (0, import_jsx_runtime77.jsx)(rootProps.slots.densityComfortableIcon, {});
      default:
        return (0, import_jsx_runtime77.jsx)(rootProps.slots.densityStandardIcon, {});
    }
  }, [density, rootProps]);
  ...
  const densityElements = densityOptions.map((option, index) => (0, import_jsx_runtime77.jsxs)(MenuItem_default, {
  ...
  return (0, import_jsx_runtime77.jsxs)(React116.Fragment, {
    children: [(0, import_jsx_runtime77.jsx)(rootProps.slots.baseTooltip, _extends({
...
var GridToolbarFilterButton = React117.forwardRef(function GridToolbarFilterButton2(props, ref) {
  var _a, _b;
  const {
    slotProps = {}
  } = props;
  ...
  const tooltipContentNode = React117.useMemo(() => {
    ...
    return (0, import_jsx_runtime78.jsxs)("div", {
      children: [apiRef.current.getLocaleText("toolbarFiltersTooltipActive")(activeFilters.length), (0, import_jsx_runtime78.jsx)(GridToolbarFilterListRoot, {
        className: classes2.root,
        ownerState: rootProps,
        children: activeFilters.map((item, index) => _extends({}, lookup[item.field] && (0, import_jsx_runtime78.jsx)("li", {
  ...
  return (0, import_jsx_runtime78.jsx)(rootProps.slots.baseTooltip, _extends({
    ...
    children: (0, import_jsx_runtime78.jsx)(rootProps.slots.baseButton, _extends({
      ...
      "aria-expanded": isOpen,
      "aria-haspopup": true,
      startIcon: (0, import_jsx_runtime78.jsx)(Badge_default, {
        badgeContent: activeFilters.length,
        color: "primary",
        children: (0, import_jsx_runtime78.jsx)(rootProps.slots.openFilterButtonIcon, {})
      })
    }, buttonProps, {
      onClick: toggleFilter
    }, (_b = rootProps.slotProps) == null ? void 0 : _b.baseButton, {
...
var GridToolbarExportContainer = React118.forwardRef(function GridToolbarExportContainer2(props, ref) {
  var _a, _b;
  const {
    children,
    slotProps = {}
  ...
  const buttonRef = React118.useRef(null);
  const handleRef = useForkRef(ref, buttonRef);
  ...
  return (0, import_jsx_runtime79.jsxs)(React118.Fragment, {
    children: [(0, import_jsx_runtime79.jsx)(rootProps.slots.baseTooltip, _extends({
      ...
      children: (0, import_jsx_runtime79.jsx)(rootProps.slots.baseButton, _extends({
        ref: handleRef,
        size: "small",
        startIcon: (0, import_jsx_runtime79.jsx)(rootProps.slots.exportIcon, {}),
        "aria-expanded": open,
    ...
    })), (0, import_jsx_runtime79.jsx)(GridMenu, {
      open,
      target: buttonRef.current,
      onClose: handleMenuClose,
      position: "bottom-start",
      children: (0, import_jsx_runtime79.jsx)(MenuList_default, {
        id: exportMenuId,
        className: gridClasses2.menuList,
...
function GridCsvExportMenuItem(props) {
  ...
  return (0, import_jsx_runtime80.jsx)(MenuItem_default, _extends({
    onClick: () => {
...
var GridToolbarExport = React119.forwardRef(function GridToolbarExport2(props, ref) {
  const {
    csvOptions = {},
    printOptions = {},
    excelOptions
  ...
  return (0, import_jsx_runtime80.jsx)(GridToolbarExportContainer, _extends({}, other, {
    ref,
    children: preProcessedButtons.map((button, index) => React119.cloneElement(button.component, {
      key: index
    }))
  }));
});
...
function GridToolbarQuickFilter(props) {
  ...
  const [searchValue, setSearchValue] = React120.useState(() => quickFilterFormatter(quickFilterValues ?? []));
  const prevQuickFilterValuesRef = React120.useRef(quickFilterValues);
  React120.useEffect(() => {
  ...
  const updateSearchValue = React120.useCallback((newSearchValue) => {
    const newQuickFilterValues = quickFilterParser(newSearchValue);
    prevQuickFilterValuesRef.current = newQuickFilterValues;
    apiRef.current.setQuickFilterValues(newQuickFilterValues);
  }, [apiRef, quickFilterParser]);
  const debouncedUpdateSearchValue = React120.useMemo(() => debounce(updateSearchValue, debounceMs), [updateSearchValue, debounceMs]);
  const handleSearchValueChange = React120.useCallback((event) => {
    const newSearchValue = event.target.value;
    setSearchValue(newSearchValue);
    debouncedUpdateSearchValue(newSearchValue);
  }, [debouncedUpdateSearchValue]);
  const handleSearchReset = React120.useCallback(() => {
    setSearchValue("");
    updateSearchValue("");
  }, [updateSearchValue]);
  return (0, import_jsx_runtime81.jsx)(GridToolbarQuickFilterRoot, _extends({
    ...
    InputProps: _extends({
      startAdornment: (0, import_jsx_runtime81.jsx)(rootProps.slots.quickFilterIcon, {
        fontSize: "small"
      }),
      endAdornment: (0, import_jsx_runtime81.jsx)(rootProps.slots.baseIconButton, _extends({
        ...
        children: (0, import_jsx_runtime81.jsx)(rootProps.slots.quickFilterClearIcon, {
          fontSize: "small"
        })
      }))
    }, other.InputProps)
...
true ? GridToolbarQuickFilter.propTypes = {
   ...
   */
  quickFilterFormatter: import_prop_types71.default.func,
  /**
   ...
   *   .filter((word) => word !== '')
   */
  quickFilterParser: import_prop_types71.default.func
} : void 0;

// node_modules/@mui/x-data-grid/components/toolbar/GridToolbar.js
var import_jsx_runtime82 = __toESM(require_jsx_runtime());
var _excluded46 = ["className", "csvOptions", "printOptions", "excelOptions", "showQuickFilter", "quickFilterProps"];
var GridToolbar = React121.forwardRef(function GridToolbar2(props, ref) {
  const {
    csvOptions,
    printOptions,
    excelOptions,
  ...
  return (0, import_jsx_runtime82.jsxs)(GridToolbarContainer, _extends({
    ...
    children: [(0, import_jsx_runtime82.jsx)(GridToolbarColumnsButton, {}), (0, import_jsx_runtime82.jsx)(GridToolbarFilterButton, {}), (0, import_jsx_runtime82.jsx)(GridToolbarDensitySelector, {}), (0, import_jsx_runtime82.jsx)(GridToolbarExport, {
      csvOptions,
      printOptions,
      excelOptions
    }), (0, import_jsx_runtime82.jsx)(Box_default, {
      sx: {
        flex: 1
      }
    }), showQuickFilter && (0, import_jsx_runtime82.jsx)(GridToolbarQuickFilter, _extends({}, quickFilterProps))]
  }));
});
true ? GridToolbar.propTypes = {
   ...
   */
  quickFilterProps: import_prop_types72.default.object,
  /**
   * Show the quick filter component.
   * @default false
   */
  showQuickFilter: import_prop_types72.default.bool,
...
var GridSelectedRowCount = React122.forwardRef(function GridSelectedRowCount2(props, ref) {
  const {
    className,
    selectedRowCount
...
true ? GridSelectedRowCount.propTypes = {
  ...
  // | To update them edit the TypeScript types and run "pnpm proptypes"  |
  // ----------------------------------------------------------------------
  selectedRowCount: import_prop_types73.default.number.isRequired,
...
var GridFooter = React123.forwardRef(function GridFooter2(props, ref) {
  var _a, _b;
  const apiRef = useGridApiContext();
  const rootProps = useGridRootProps();
  ...
  const rowCountElement = !rootProps.hideFooterRowCount && !rootProps.pagination ? (0, import_jsx_runtime84.jsx)(rootProps.slots.footerRowCount, _extends({}, (_a = rootProps.slotProps) == null ? void 0 : _a.footerRowCount, {
    rowCount: totalTopLevelRowCount,
    visibleRowCount: visibleTopLevelRowCount
  })) : null;
  const paginationElement = rootProps.pagination && !rootProps.hideFooterPagination && rootProps.slots.pagination && (0, import_jsx_runtime84.jsx)(rootProps.slots.pagination, _extends({}, (_b = rootProps.slotProps) == null ? void 0 : _b.pagination));
...
function GridPreferencesPanel() {
  ...
  return (0, import_jsx_runtime85.jsx)(rootProps.slots.panel, _extends({
    as: rootProps.slots.basePopper,
...
function GridHeader() {
  var _a;
  const rootProps = useGridRootProps();
  return (0, import_jsx_runtime86.jsxs)(React125.Fragment, {
    children: [(0, import_jsx_runtime86.jsx)(GridPreferencesPanel, {}), rootProps.slots.toolbar && (0, import_jsx_runtime86.jsx)(rootProps.slots.toolbar, _extends({}, (_a = rootProps.slotProps) == null ? void 0 : _a.toolbar))]
  });
}
...
var GridSkeletonLoadingOverlay = React127.forwardRef(function GridSkeletonLoadingOverlay2(props, forwardedRef) {
  const rootProps = useGridRootProps();
  const {
    slots
  } = rootProps;
  ...
  const inViewportCount = React127.useMemo(() => positions.filter((value) => value <= totalWidth).length, [totalWidth, positions]);
  const allVisibleColumns = useGridSelector(apiRef, gridVisibleColumnDefinitionsSelector);
  const columns = React127.useMemo(() => allVisibleColumns.slice(0, inViewportCount), [allVisibleColumns, inViewportCount]);
  const pinnedColumns = useGridSelector(apiRef, gridVisiblePinnedColumnDefinitionsSelector);
  const getPinnedStyle = React127.useCallback((computedWidth, index, position2) => {
    const pinnedOffset = getPinnedCellOffset(position2, computedWidth, index, positions, dimensions);
    return {
      [position2]: pinnedOffset
    };
  }, [dimensions, positions]);
  const getPinnedPosition = React127.useCallback((field) => {
  ...
  const children = React127.useMemo(() => {
    const array = [];
    for (let i = 0; i < skeletonRowsCount; i += 1) {
      ...
      for (let colIndex = 0; colIndex < columns.length; colIndex += 1) {
        ...
        const emptyCell = (0, import_jsx_runtime88.jsx)(slots.skeletonCell, {
        ...
        rowCells.push((0, import_jsx_runtime88.jsx)(slots.skeletonCell, {
          field: column.field,
          type: column.type,
          align: column.align,
          width: "var(--width)",
        ...
        if (hasScrollbarFiller) {
          rowCells.push((0, import_jsx_runtime88.jsx)(GridScrollbarFillerCell, {
            pinnedRight: pinnedColumns.right.length > 0
          }, `skeleton-scrollbar-filler-${i}`));
        }
      }
      array.push((0, import_jsx_runtime88.jsx)("div", {
  ...
  return (0, import_jsx_runtime88.jsx)(SkeletonOverlay, _extends({
    className: classes2.root,
    ref: handleRef
  }, props, {
    children
...
var GridLoadingOverlay = React128.forwardRef(function GridLoadingOverlay2(props, ref) {
  const {
  ...
  return (0, import_jsx_runtime89.jsx)(GridOverlay, _extends({
    ...
    children: (0, import_jsx_runtime89.jsx)(activeVariant.component, {})
  }));
});
true ? GridLoadingOverlay.propTypes = {
   ...
   */
  noRowsVariant: import_prop_types75.default.oneOf(["circular-progress", "linear-progress", "skeleton"]),
   ...
   * @default 'circular-progress'
   */
  variant: import_prop_types75.default.oneOf(["circular-progress", "linear-progress", "skeleton"])
} : void 0;
...
var GridNoRowsOverlay = React129.forwardRef(function GridNoRowsOverlay2(props, ref) {
  const apiRef = useGridApiContext();
...
var GridPagination = React130.forwardRef(function GridPagination2(props, ref) {
  var _a;
  const apiRef = useGridApiContext();
  const rootProps = useGridRootProps();
  ...
  const computedProps = React130.useMemo(() => {
  ...
  const lastPage = React130.useMemo(() => Math.max(0, pageCount - 1), [pageCount]);
  const computedPage = React130.useMemo(() => {
    if (rowCount === -1) {
      return paginationModel.page;
    }
    return paginationModel.page <= lastPage ? paginationModel.page : lastPage;
  }, [lastPage, paginationModel.page, rowCount]);
  const handlePageSizeChange = React130.useCallback((event) => {
    const pageSize = Number(event.target.value);
    apiRef.current.setPageSize(pageSize);
  }, [apiRef]);
  const handlePageChange = React130.useCallback((_, page) => {
  ...
  if (true) {
    const warnedOnceMissingInPageSizeOptions = React130.useRef(false);
  ...
  return (0, import_jsx_runtime91.jsx)(GridPaginationRoot, _extends({
    ref,
    component: "div",
    count: rowCount,
    page: computedPage,
...
var GridRowCount = React131.forwardRef(function GridRowCount2(props, ref) {
  const {
    className,
    rowCount,
    visibleRowCount
  ...
  return (0, import_jsx_runtime92.jsxs)(GridRowCountRoot, _extends({
    ref,
    className: clsx_default(classes2.root, className),
    ownerState
  }, other, {
...
true ? GridRowCount.propTypes = {
  ...
  // | To update them edit the TypeScript types and run "pnpm proptypes"  |
  // ----------------------------------------------------------------------
  rowCount: import_prop_types78.default.number.isRequired,
  ...
  visibleRowCount: import_prop_types78.default.number.isRequired
} : void 0;
...
var GridRow = React132.forwardRef(function GridRow2(props, refProp) {
  var _a;
  const {
    selected,
    rowId,
  ...
  const apiRef = useGridApiContext();
  const configuration2 = useGridConfiguration();
  const ref = React132.useRef(null);
  const rootProps = useGridRootProps();
  const currentPage = useGridVisibleRows(apiRef, rootProps);
  const sortModel = useGridSelector(apiRef, gridSortModelSelector);
  ...
  const publish = React132.useCallback((eventName, propHandler) => (event) => {
    if (isEventTargetInPortal(event)) {
      return;
    }
    if (!apiRef.current.getRow(rowId)) {
  ...
  const publishClick = React132.useCallback((event) => {
  ...
  const getCell = (column, indexInSection, indexRelativeToAllColumns, sectionLength, pinnedPosition = PinnedPosition.NONE) => {
    ...
    if ((rowNode == null ? void 0 : rowNode.type) === "skeletonRow") {
      return (0, import_jsx_runtime93.jsx)(slots.skeletonCell, {
        type: column.type,
        width: width2,
        height: rowHeight,
        field: column.field,
    ...
    return (0, import_jsx_runtime93.jsx)(slots.cell, _extends({
      column,
      width: width2,
      rowId,
  ...
  return (0, import_jsx_runtime93.jsxs)("div", _extends({
    ...
    children: [leftCells, (0, import_jsx_runtime93.jsx)("div", {
      role: "presentation",
      className: gridClasses2.cellOffsetLeft,
      style: {
        width: offsetLeft
      }
    }), cells, emptyCellWidth > 0 && (0, import_jsx_runtime93.jsx)(EmptyCell, {
      width: emptyCellWidth
    }), rightCells.length > 0 && (0, import_jsx_runtime93.jsx)("div", {
      role: "presentation",
      className: gridClasses2.filler
    }), rightCells, scrollbarWidth !== 0 && (0, import_jsx_runtime93.jsx)(GridScrollbarFillerCell, {
      pinnedRight: pinnedColumns.right.length > 0
    })]
  }));
});
true ? GridRow.propTypes = {
  ...
  // | To update them edit the TypeScript types and run "pnpm proptypes"  |
  // ----------------------------------------------------------------------
  dimensions: import_prop_types79.default.shape({
    bottomContainerHeight: import_prop_types79.default.number.isRequired,
    columnsTotalWidth: import_prop_types79.default.number.isRequired,
    contentSize: import_prop_types79.default.shape({
      height: import_prop_types79.default.number.isRequired,
      width: import_prop_types79.default.number.isRequired
    }).isRequired,
    groupHeaderHeight: import_prop_types79.default.number.isRequired,
    hasScrollX: import_prop_types79.default.bool.isRequired,
    hasScrollY: import_prop_types79.default.bool.isRequired,
    headerFilterHeight: import_prop_types79.default.number.isRequired,
    headerHeight: import_prop_types79.default.number.isRequired,
    headersTotalHeight: import_prop_types79.default.number.isRequired,
    isReady: import_prop_types79.default.bool.isRequired,
    leftPinnedWidth: import_prop_types79.default.number.isRequired,
    minimumSize: import_prop_types79.default.shape({
      height: import_prop_types79.default.number.isRequired,
      width: import_prop_types79.default.number.isRequired
    }).isRequired,
    rightPinnedWidth: import_prop_types79.default.number.isRequired,
    root: import_prop_types79.default.shape({
      height: import_prop_types79.default.number.isRequired,
      width: import_prop_types79.default.number.isRequired
    }).isRequired,
    rowHeight: import_prop_types79.default.number.isRequired,
    rowWidth: import_prop_types79.default.number.isRequired,
    scrollbarSize: import_prop_types79.default.number.isRequired,
    topContainerHeight: import_prop_types79.default.number.isRequired,
    viewportInnerSize: import_prop_types79.default.shape({
      height: import_prop_types79.default.number.isRequired,
      width: import_prop_types79.default.number.isRequired
    }).isRequired,
    viewportOuterSize: import_prop_types79.default.shape({
      height: import_prop_types79.default.number.isRequired,
      width: import_prop_types79.default.number.isRequired
    }).isRequired
  }).isRequired,
   ...
   */
  focusedColumnIndex: import_prop_types79.default.number,
  /**
   * Index of the row in the whole sorted and filtered dataset.
   * If some rows above have expanded children, this index also take those children into account.
   */
  index: import_prop_types79.default.number.isRequired,
  isFirstVisible: import_prop_types79.default.bool.isRequired,
  isLastVisible: import_prop_types79.default.bool.isRequired,
  isNotVisible: import_prop_types79.default.bool.isRequired,
  offsetLeft: import_prop_types79.default.number.isRequired,
  offsetTop: import_prop_types79.default.number,
  onClick: import_prop_types79.default.func,
  onDoubleClick: import_prop_types79.default.func,
  onMouseEnter: import_prop_types79.default.func,
  onMouseLeave: import_prop_types79.default.func,
  pinnedColumns: import_prop_types79.default.object.isRequired,
  renderContext: import_prop_types79.default.shape({
    firstColumnIndex: import_prop_types79.default.number.isRequired,
    firstRowIndex: import_prop_types79.default.number.isRequired,
    lastColumnIndex: import_prop_types79.default.number.isRequired,
    lastRowIndex: import_prop_types79.default.number.isRequired
  }).isRequired,
  row: import_prop_types79.default.object.isRequired,
  rowHeight: import_prop_types79.default.oneOfType([import_prop_types79.default.oneOf(["auto"]), import_prop_types79.default.number]).isRequired,
  rowId: import_prop_types79.default.oneOfType([import_prop_types79.default.number, import_prop_types79.default.string]).isRequired,
  selected: import_prop_types79.default.bool.isRequired,
  showBottomBorder: import_prop_types79.default.bool.isRequired,
  /**
   * Determines which cell should be tabbable by having tabIndex=0.
   * If `null`, no cell in this row is in the tab sequence.
   */
  tabbableCell: import_prop_types79.default.string,
  visibleColumns: import_prop_types79.default.arrayOf(import_prop_types79.default.object).isRequired
} : void 0;
...
var useGridRowAriaAttributes = () => {
  ...
  const headerGroupingMaxDepth = useGridSelector(apiRef, gridColumnGroupsHeaderMaxDepthSelector);
  return React133.useCallback((rowNode, index) => {
...
function GridContextProvider({
  ...
  const apiRef = React134.useRef(privateApiRef.current.getPublicApi());
  return (0, import_jsx_runtime94.jsx)(GridConfigurationContext.Provider, {
    value: configuration2,
    children: (0, import_jsx_runtime94.jsx)(GridRootPropsContext.Provider, {
      value: props,
...
var useGridRefs = (apiRef) => {
  const rootElementRef = React135.useRef(null);
  const mainElementRef = React135.useRef(null);
  const virtualScrollerRef = React135.useRef(null);
  const columnHeadersContainerRef = React135.useRef(null);
...
var useGridIsRtl = (apiRef) => {
  ...
  const isFirstEffect = React136.useRef(true);
  React136.useEffect(() => {
...
var useGridLoggerFactory = (apiRef, props) => {
  const getLogger = React137.useCallback((name) => {
    if (forceDebug) {
...
function useGridApiInitialization(inputApiRef, props) {
  var _a;
  const publicApiRef = React138.useRef();
  const privateApiRef = React138.useRef();
  ...
  const publishEvent = React138.useCallback((...args) => {
  ...
  const subscribeEvent = React138.useCallback((event, handler, options) => {
  ...
  React138.useImperativeHandle(inputApiRef, () => publicApiRef.current, [publicApiRef]);
  React138.useEffect(() => {
    const api = privateApiRef.current;
    return () => {
...
var useGridLocaleText = (apiRef, props) => {
  const getLocaleText = React139.useCallback((key) => {
...
var useGridPipeProcessing = (apiRef) => {
  const cache3 = React140.useRef({});
  const isRunning = React140.useRef(false);
  const runAppliers = React140.useCallback((groupCache) => {
  ...
  const registerPipeProcessor = React140.useCallback((group, id, processor) => {
  ...
  const registerPipeApplier = React140.useCallback((group, id, applier) => {
    if (!cache3.current[group]) {
      cache3.current[group] = {
        processors: /* @__PURE__ */ new Map(),
        processorsAsArray: [],
    ...
    return () => {
      const _appliers = cache3.current[group].appliers, otherAppliers = _objectWithoutPropertiesLoose(_appliers, [id].map(toPropertyKey));
      cache3.current[group].appliers = otherAppliers;
    };
  }, []);
  const requestPipeProcessorsApplication = React140.useCallback((group) => {
    runAppliers(cache3.current[group]);
  }, [runAppliers]);
  const applyPipeProcessors = React140.useCallback((...args) => {
...
var useGridRegisterPipeProcessor = (apiRef, group, callback) => {
  const cleanup = React141.useRef();
  const id = React141.useRef(`mui-${Math.round(Math.random() * 1e9)}`);
  const registerPreProcessor = React141.useCallback(() => {
    cleanup.current = apiRef.current.registerPipeProcessor(group, id.current, callback);
  }, [apiRef, callback, group]);
  useFirstRender(() => {
    registerPreProcessor();
  });
  const isFirstRender = React141.useRef(true);
  React141.useEffect(() => {
    if (isFirstRender.current) {
      isFirstRender.current = false;
    } else {
...
var useGridRegisterPipeApplier = (apiRef, group, callback) => {
  const cleanup = React142.useRef();
  const id = React142.useRef(`mui-${Math.round(Math.random() * 1e9)}`);
  const registerPreProcessor = React142.useCallback(() => {
...
var useGridRegisterStrategyProcessor = (apiRef, strategyName, group, processor) => {
  const registerPreProcessor = React143.useCallback(() => {
...
var useGridStrategyProcessing = (apiRef) => {
  const availableStrategies = React144.useRef(/* @__PURE__ */ new Map());
  const strategiesCache = React144.useRef({});
  const registerStrategyProcessor = React144.useCallback((strategyName, processorName, processor) => {
    const cleanup = () => {
  ...
  const applyStrategyProcessor = React144.useCallback((processorName, params) => {
  ...
  const getActiveStrategy = React144.useCallback((strategyGroup) => {
  ...
  const setStrategyAvailability = React144.useCallback((strategyGroup, strategyName, isAvailable) => {
...
var useGridStateInitialization = (apiRef) => {
  const controlStateMapRef = React145.useRef({});
  const [, rawForceUpdate] = React145.useState();
  const registerControlState = React145.useCallback((controlStateItem) => {
    controlStateMapRef.current[controlStateItem.stateId] = controlStateItem;
  }, []);
  const setState = React145.useCallback((state, reason) => {
    let newState;
    if (isFunction(state)) {
  ...
  const updateControlState = React145.useCallback((key, state, reason) => {
  ...
  const forceUpdate = React145.useCallback(() => rawForceUpdate(() => apiRef.current.state), [apiRef]);
...
var useGridInitializeState = (initializer, privateApiRef, props) => {
  const isInitialized = React146.useRef(false);
...
var useGridClipboard = (apiRef, props) => {
  ...
  const handleCopy = React147.useCallback((event) => {
...
var useGridColumnMenu = (apiRef) => {
  ...
  const showColumnMenu = React148.useCallback((field) => {
  ...
  const hideColumnMenu = React148.useCallback(() => {
    const columnMenuState = gridColumnMenuSelector(apiRef.current.state);
  ...
  const toggleColumnMenu = React148.useCallback((field) => {
...
function useGridColumns(apiRef, props) {
  ...
  const previousColumnsProp = React149.useRef(props.columns);
  ...
  const setGridColumnsState = React149.useCallback((columnsState) => {
    var _a2, _b2;
  ...
  const getColumn = React149.useCallback((field) => gridColumnLookupSelector(apiRef)[field], [apiRef]);
  const getAllColumns = React149.useCallback(() => gridColumnDefinitionsSelector(apiRef), [apiRef]);
  const getVisibleColumns = React149.useCallback(() => gridVisibleColumnDefinitionsSelector(apiRef), [apiRef]);
  const getColumnIndex = React149.useCallback((field, useVisibleColumns = true) => {
    const columns = useVisibleColumns ? gridVisibleColumnDefinitionsSelector(apiRef) : gridColumnDefinitionsSelector(apiRef);
    return columns.findIndex((col) => col.field === field);
  }, [apiRef]);
  const getColumnPosition = React149.useCallback((field) => {
    const index = getColumnIndex(field);
    return gridColumnPositionsSelector(apiRef)[index];
  }, [apiRef, getColumnIndex]);
  const setColumnVisibilityModel = React149.useCallback((model) => {
    var _a2, _b2;
    const currentModel = gridColumnVisibilityModelSelector(apiRef);
  ...
  const updateColumns = React149.useCallback((columns) => {
    const columnsState = createColumnsState({
      apiRef,
  ...
  const setColumnVisibility = React149.useCallback((field, isVisible) => {
    const columnVisibilityModel = gridColumnVisibilityModelSelector(apiRef);
  ...
  const getColumnIndexRelativeToVisibleColumns = React149.useCallback((field) => {
    const allColumns = gridColumnFieldsSelector(apiRef);
    return allColumns.findIndex((col) => col === field);
  }, [apiRef]);
  const setColumnIndex = React149.useCallback((field, targetIndexPosition) => {
    const allColumns = gridColumnFieldsSelector(apiRef);
  ...
  const setColumnWidth = React149.useCallback((field, width2) => {
  ...
  const preferencePanelPreProcessing = React149.useCallback((initialValue, value) => {
    ...
    if (value === GridPreferencePanelsValue.columns) {
      ...
      return (0, import_jsx_runtime95.jsx)(ColumnsPanel, _extends({}, (_a2 = props.slotProps) == null ? void 0 : _a2.columnsPanel));
    }
    return initialValue;
  }, [props.slots.columnsPanel, (_b = props.slotProps) == null ? void 0 : _b.columnsPanel]);
  const addColumnMenuItems = React149.useCallback((columnMenuItems) => {
  ...
  const prevInnerWidth = React149.useRef(null);
  ...
  const hydrateColumns = React149.useCallback(() => {
...
var useGridCsvExport = (apiRef, props) => {
  ...
  const getDataAsCsv = React151.useCallback((options = {}) => {
  ...
  const exportDataAsCsv = React151.useCallback((options) => {
  ...
  const addExportMenuButtons = React151.useCallback((initialValue, options) => {
    var _a;
...
var useGridPaginationModel = (apiRef, props) => {
  ...
  const setPaginationModel = React152.useCallback((paginationModel) => {
    const currentModel = gridPaginationModelSelector(apiRef);
  ...
  const handleRowCountChange = React152.useCallback((newRowCount) => {
    if (newRowCount == null) {
      return;
    }
    const paginationModel = gridPaginationModelSelector(apiRef);
  ...
  React152.useEffect(handleUpdateAutoPageSize, [handleUpdateAutoPageSize]);
};
...
var useGridPrintExport = (apiRef, props) => {
  ...
  const doc = React153.useRef(null);
  const previousGridState = React153.useRef(null);
  const previousColumnVisibility = React153.useRef({});
  const previousRows = React153.useRef([]);
  const previousVirtualizationState = React153.useRef();
  React153.useEffect(() => {
    doc.current = ownerDocument(apiRef.current.rootElementRef.current);
  }, [apiRef, hasRootReference]);
  const updateGridColumnsForPrint = React153.useCallback((fields, allColumns, includeCheckboxes) => new Promise((resolve) => {
  ...
  const updateGridRowsForPrint = React153.useCallback((getRowsToExport) => {
  ...
  const handlePrintWindowLoad = React153.useCallback((printWindow, options) => {
    var _a, _b, _c, _d;
...
`;
  ...
  const handlePrintWindowAfterPrint = React153.useCallback((printWindow) => {
    var _a, _b;
  ...
  const exportDataAsPrint = React153.useCallback(async (options) => {
  ...
  const addExportMenuButtons = React153.useCallback((initialValue, options) => {
    var _a;
...
var useGridFilter = (apiRef, props) => {
  ...
  const updateFilteredRows = React154.useCallback(() => {
    apiRef.current.setState((state) => {
  ...
  const applyFilters = React154.useCallback(() => {
    updateFilteredRows();
    apiRef.current.forceUpdate();
  }, [apiRef, updateFilteredRows]);
  const upsertFilterItem = React154.useCallback((item) => {
  ...
  const upsertFilterItems = React154.useCallback((items) => {
    const filterModel = gridFilterModelSelector(apiRef);
  ...
  const deleteFilterItem = React154.useCallback((itemToDelete) => {
    const filterModel = gridFilterModelSelector(apiRef);
  ...
  const showFilterPanel = React154.useCallback((targetColumnField, panelId, labelId) => {
  ...
  const hideFilterPanel = React154.useCallback(() => {
    logger.debug("Hiding filter panel");
    apiRef.current.hidePreferences();
  }, [apiRef, logger]);
  const setFilterLogicOperator = React154.useCallback((logicOperator) => {
    const filterModel = gridFilterModelSelector(apiRef);
  ...
  const setQuickFilterValues = React154.useCallback((values2) => {
    const filterModel = gridFilterModelSelector(apiRef);
  ...
  const setFilterModel = React154.useCallback((model, reason) => {
  ...
  const getFilterState = React154.useCallback((inputFilterModel) => {
  ...
  const preferencePanelPreProcessing = React154.useCallback((initialValue, value) => {
    var _a2;
    if (value === GridPreferencePanelsValue.filters) {
      const FilterPanel = props.slots.filterPanel;
      return (0, import_jsx_runtime98.jsx)(FilterPanel, _extends({}, (_a2 = props.slotProps) == null ? void 0 : _a2.filterPanel));
    }
    return initialValue;
  ...
  const flatFilteringMethod = React154.useCallback((params) => {
  ...
  const updateVisibleRowsLookupState = React154.useCallback(() => {
    apiRef.current.setState((state) => {
      return _extends({}, state, {
...
var useGridFocus = (apiRef, props) => {
  ...
  const lastClickedCell = React155.useRef(null);
  const hasRootReference = apiRef.current.rootElementRef.current !== null;
  const publishCellFocusOut = React155.useCallback((cell, event) => {
    if (cell) {
  ...
  const setCellFocus = React155.useCallback((id, field) => {
    const focusedCell = gridFocusCellSelector(apiRef);
  ...
  const setColumnHeaderFocus = React155.useCallback((field, event = {}) => {
  ...
  const setColumnHeaderFilterFocus = React155.useCallback((field, event = {}) => {
    const cell = gridFocusCellSelector(apiRef);
    publishCellFocusOut(cell, event);
    apiRef.current.setState((state) => {
  ...
  const setColumnGroupHeaderFocus = React155.useCallback((field, depth, event = {}) => {
    const cell = gridFocusCellSelector(apiRef);
    if (cell) {
      apiRef.current.publishEvent("cellFocusOut", apiRef.current.getCellParams(cell.id, cell.field), event);
    }
  ...
  const getColumnGroupHeaderFocus = React155.useCallback(() => gridFocusColumnGroupHeaderSelector(apiRef), [apiRef]);
  const moveFocusToRelativeCell = React155.useCallback((id, field, direction) => {
  ...
  const handleCellDoubleClick = React155.useCallback(({
    id,
    field
  }) => {
  ...
  const handleColumnHeaderFocus = React155.useCallback(({
    field
  }, event) => {
  ...
  const handleColumnGroupHeaderFocus = React155.useCallback(({
    fields,
    depth
  }, event) => {
    if (event.target !== event.currentTarget) {
  ...
  const handleBlur = React155.useCallback((_, event) => {
    var _a, _b;
  ...
  const handleCellMouseDown = React155.useCallback((params) => {
    lastClickedCell.current = params;
  }, []);
  const handleDocumentClick = React155.useCallback((event) => {
  ...
  const handleCellModeChange = React155.useCallback((params) => {
  ...
  const handleRowSet = React155.useCallback(() => {
    const cell = gridFocusCellSelector(apiRef);
...
var useGridKeyboardNavigation = (apiRef, props) => {
  ...
  const isRtl = useRtl();
  const currentPageRows = React156.useMemo(() => enrichPageRowsWithPinnedRows(apiRef, initialCurrentPageRows), [apiRef, initialCurrentPageRows]);
  const headerFilteringEnabled = props.signature !== "DataGrid" && props.headerFilters;
  const goToCell = React156.useCallback((colIndex, rowId, closestColumnToUse = "left", rowSpanScanDirection = "up") => {
  ...
  const goToHeader = React156.useCallback((colIndex, event) => {
  ...
  const goToHeaderFilter = React156.useCallback((colIndex, event) => {
  ...
  const goToGroupHeader = React156.useCallback((colIndex, depth, event) => {
    logger.debug(`Navigating to header col ${colIndex}`);
    apiRef.current.scrollToIndexes({
      colIndex
    });
  ...
  const getRowIdFromIndex = React156.useCallback((rowIndex) => {
    var _a;
    return (_a = currentPageRows[rowIndex]) == null ? void 0 : _a.id;
  }, [currentPageRows]);
  const handleColumnHeaderKeyDown = React156.useCallback((params, event) => {
  ...
  const handleHeaderFilterKeyDown = React156.useCallback((params, event) => {
  ...
  const handleColumnGroupHeaderKeyDown = React156.useCallback((params, event) => {
    const focusedColumnGroup = gridFocusColumnGroupHeaderSelector(apiRef);
  ...
  const checkIfCanStartEditing = React156.useCallback((initialValue, {
    event
  }) => {
    if (event.key === " ") {
      return false;
...
var useGridRowCount = (apiRef, props) => {
  ...
  const setRowCount = React157.useCallback((newRowCount) => {
  ...
  useGridRegisterPipeProcessor(apiRef, "exportState", stateExportPreProcessing);
  useGridRegisterPipeProcessor(apiRef, "restoreState", stateRestorePreProcessing);
  const handlePaginationModelChange = React157.useCallback((model) => {
...
var useGridPaginationMeta = (apiRef, props) => {
  ...
  const setPaginationMeta = React158.useCallback((newPaginationMeta) => {
...
var useGridPreferencesPanel = (apiRef, props) => {
  ...
  const hideTimeout = React159.useRef();
  const immediateTimeout = React159.useRef();
  const hidePreferences = React159.useCallback(() => {
  ...
  const doNotHidePanel = React159.useCallback(() => {
    immediateTimeout.current = setTimeout(() => clearTimeout(hideTimeout.current), 0);
  }, []);
  const hidePreferencesDelayed = React159.useCallback(() => {
    hideTimeout.current = setTimeout(hidePreferences, 100);
  }, [hidePreferences]);
  const showPreferences = React159.useCallback((newValue, panelId, labelId) => {
  ...
  const stateExportPreProcessing = React159.useCallback((prevState, context) => {
    var _a2;
  ...
  const stateRestorePreProcessing = React159.useCallback((params, context) => {
...
var useGridCellEditing = (apiRef, props) => {
  const [cellModesModel, setCellModesModel] = React160.useState({});
  const cellModesModelRef = React160.useRef(cellModesModel);
  const prevCellModesModel = React160.useRef({});
  const {
    processRowUpdate,
  ...
  const throwIfNotEditable = React160.useCallback((id, field) => {
    const params = apiRef.current.getCellParams(id, field);
    if (!apiRef.current.isCellEditable(params)) {
      throw new Error(`MUI X: The cell with id=${id} and field=${field} is not editable.`);
    }
  }, [apiRef]);
  const throwIfNotInMode = React160.useCallback((id, field, mode) => {
    if (apiRef.current.getCellMode(id, field) !== mode) {
      throw new Error(`MUI X: The cell with id=${id} and field=${field} is not in ${mode} mode.`);
    }
  }, [apiRef]);
  const handleCellDoubleClick = React160.useCallback((params, event) => {
  ...
  const handleCellFocusOut = React160.useCallback((params, event) => {
  ...
  const handleCellKeyDown = React160.useCallback((params, event) => {
    if (params.cellMode === GridCellModes.Edit) {
      if (event.which === 229) {
        return;
      }
  ...
  const handleCellEditStart = React160.useCallback((params) => {
    const {
      id,
      field,
      reason
  ...
  const handleCellEditStop = React160.useCallback((params) => {
    const {
      id,
      field,
      reason
  ...
  const getCellMode = React160.useCallback((id, field) => {
  ...
  const updateFieldInCellModesModel = React160.useCallback((id, field, newProps) => {
  ...
  const updateOrDeleteFieldState = React160.useCallback((id, field, newProps) => {
    apiRef.current.setState((state) => {
  ...
  const startCellEditMode = React160.useCallback((params) => {
    const {
      id,
      field
  ...
  const stopCellEditMode = React160.useCallback((params) => {
    const {
      id,
      field
  ...
  const setCellEditingEditCellValue = React160.useCallback(async (params) => {
    var _a, _b;
    const {
      id,
      field,
  ...
  const getRowWithUpdatedValuesFromCellEditing = React160.useCallback((id, field) => {
    const column = apiRef.current.getColumn(field);
    const editingState = gridEditRowsStateSelector(apiRef.current.state);
    const row = apiRef.current.getRow(id);
...
var useGridRowEditing = (apiRef, props) => {
  const [rowModesModel, setRowModesModel] = React161.useState({});
  const rowModesModelRef = React161.useRef(rowModesModel);
  const prevRowModesModel = React161.useRef({});
  const focusTimeout = React161.useRef();
  const nextFocusedCell = React161.useRef(null);
  const {
    processRowUpdate,
    onProcessRowUpdateError,
  ...
  const throwIfNotEditable = React161.useCallback((id, field) => {
    const params = apiRef.current.getCellParams(id, field);
    if (!apiRef.current.isCellEditable(params)) {
      throw new Error(`MUI X: The cell with id=${id} and field=${field} is not editable.`);
    }
  }, [apiRef]);
  const throwIfNotInMode = React161.useCallback((id, mode) => {
    if (apiRef.current.getRowMode(id) !== mode) {
      throw new Error(`MUI X: The row with id=${id} is not in ${mode} mode.`);
    }
  }, [apiRef]);
  const hasFieldsWithErrors = React161.useCallback((rowId) => {
    const editingState = gridEditRowsStateSelector(apiRef.current.state);
    return Object.values(editingState[rowId]).some((fieldProps) => fieldProps.error);
  }, [apiRef]);
  const handleCellDoubleClick = React161.useCallback((params, event) => {
    if (!params.isEditable) {
      return;
    }
  ...
  const handleCellFocusIn = React161.useCallback((params) => {
    nextFocusedCell.current = params;
  }, []);
  const handleCellFocusOut = React161.useCallback((params, event) => {
    if (!params.isEditable) {
      return;
    }
  ...
  const handleRowEditStart = React161.useCallback((params) => {
    const {
      id,
      field,
      reason
  ...
  const handleRowEditStop = React161.useCallback((params) => {
    const {
      id,
      reason,
      field
  ...
  const getRowMode = React161.useCallback((id) => {
    if (props.editMode === GridEditModes.Cell) {
  ...
  const updateRowInRowModesModel = React161.useCallback((id, newProps) => {
  ...
  const updateOrDeleteRowState = React161.useCallback((id, newProps) => {
    apiRef.current.setState((state) => {
      const newEditingState = _extends({}, state.editRows);
      if (newProps !== null) {
  ...
  const updateOrDeleteFieldState = React161.useCallback((id, field, newProps) => {
    apiRef.current.setState((state) => {
      const newEditingState = _extends({}, state.editRows);
      if (newProps !== null) {
        newEditingState[id] = _extends({}, newEditingState[id], {
  ...
  const startRowEditMode = React161.useCallback((params) => {
    const {
      id
  ...
  const stopRowEditMode = React161.useCallback((params) => {
    const {
      id
  ...
  const setRowEditingEditCellValue = React161.useCallback((params) => {
    const {
      id,
      field,
      value,
  ...
  const getRowWithUpdatedValuesFromRowEditing = React161.useCallback((id) => {
    const editingState = gridEditRowsStateSelector(apiRef.current.state);
    const row = apiRef.current.getRow(id);
    if (!editingState[id]) {
      return apiRef.current.getRow(id);
...
var useGridEditing = (apiRef, props) => {
  ...
  const debounceMap = React162.useRef({});
  const {
    isCellEditable: isCellEditableProp
  } = props;
  const isCellEditable = React162.useCallback((params) => {
  ...
  const runPendingEditCellValueMutation = React162.useCallback((id, field) => {
    if (!debounceMap.current[id]) {
      return;
    }
    if (!field) {
  ...
  const setEditCellValue = React162.useCallback((params) => {
    const {
      id,
      field,
      debounceMs
  ...
  const getRowWithUpdatedValues = React162.useCallback((id, field) => {
    return props.editMode === GridEditModes.Cell ? apiRef.current.getRowWithUpdatedValuesFromCellEditing(id, field) : apiRef.current.getRowWithUpdatedValuesFromRowEditing(id);
  }, [apiRef, props.editMode]);
  const getEditCellMeta = React162.useCallback((id, field) => {
    var _a;
    const editingState = gridEditRowsStateSelector(apiRef.current.state);
...
var useGridRows = (apiRef, props) => {
  ...
  const lastUpdateMs = React163.useRef(Date.now());
  const lastRowCount = React163.useRef(props.rowCount);
  const timeout = useTimeout();
  const getRow = React163.useCallback((id) => {
  ...
  const getRowId = React163.useCallback((row) => {
  ...
  const lookup = React163.useMemo(() => currentPage.rows.reduce((acc, {
    id
  }, index) => {
    acc[id] = index;
    return acc;
  }, {}), [currentPage.rows]);
  const throttledRowsChange = React163.useCallback(({
    cache: cache3,
    throttle: throttle2
  }) => {
    const run = () => {
  ...
  const setRows = React163.useCallback((rows) => {
  ...
  const updateRows = React163.useCallback((updates) => {
  ...
  const updateServerRows = React163.useCallback((updates, groupKeys) => {
    const nonPinnedRowsUpdates = computeRowsUpdates(apiRef, updates, props.getRowId);
    const cache3 = updateCacheWithNewRows({
      updates: nonPinnedRowsUpdates,
      getRowId: props.getRowId,
  ...
  const setLoading = React163.useCallback((loading) => {
  ...
  const getRowModels = React163.useCallback(() => {
    const dataRows = gridDataRowIdsSelector(apiRef);
    const idRowsLookup = gridRowsLookupSelector(apiRef);
    return new Map(dataRows.map((id) => [id, idRowsLookup[id] ?? {}]));
  }, [apiRef]);
  const getRowsCount = React163.useCallback(() => gridRowCountSelector(apiRef), [apiRef]);
  const getAllRowIds = React163.useCallback(() => gridDataRowIdsSelector(apiRef), [apiRef]);
  const getRowIndexRelativeToVisibleRows = React163.useCallback((id) => lookup[id], [lookup]);
  const setRowChildrenExpansion = React163.useCallback((id, isExpanded) => {
  ...
  const getRowNode = React163.useCallback((id) => gridRowTreeSelector(apiRef)[id] ?? null, [apiRef]);
  const getRowGroupChildren = React163.useCallback(({
  ...
  const setRowIndex = React163.useCallback((rowId, targetIndex) => {
  ...
  const replaceRows = React163.useCallback((firstRowToRender, newRows) => {
  ...
  const groupRows = React163.useCallback(() => {
  ...
  const handleStrategyProcessorChange = React163.useCallback((methodName) => {
    if (methodName === "rowTreeCreation") {
      groupRows();
    }
  }, [groupRows]);
  const handleStrategyActivityChange = React163.useCallback(() => {
  ...
  const applyHydrateRowsProcessor = React163.useCallback(() => {
    apiRef.current.setState((state) => {
  ...
  const isFirstRender = React163.useRef(true);
  React163.useEffect(() => {
    var _a;
    if (isFirstRender.current) {
      isFirstRender.current = false;
...
var useGridRowSelection = (apiRef, props) => {
  ...
  const propRowSelectionModel = React164.useMemo(() => {
    return getSelectionModelPropValue(props.rowSelectionModel, gridRowSelectionStateSelector(apiRef.current.state));
  }, [apiRef, props.rowSelectionModel]);
  const lastRowToggled = React164.useRef(null);
  apiRef.current.registerControlState({
  ...
  const expandMouseRowRangeSelection = React164.useCallback((id) => {
    let endId = id;
  ...
  const setRowSelectionModel = React164.useCallback((model) => {
  ...
  const isRowSelected = React164.useCallback((id) => gridRowSelectionStateSelector(apiRef.current.state).includes(id), [apiRef]);
  const isRowSelectable = React164.useCallback((id) => {
  ...
  const getSelectedRows = React164.useCallback(() => selectedGridRowsSelector(apiRef), [apiRef]);
  const selectRow = React164.useCallback((id, isSelected = true, resetSelection = false) => {
  ...
  const selectRows = React164.useCallback((ids, isSelected = true, resetSelection = false) => {
  ...
  const selectRowRange = React164.useCallback(({
    startId,
    endId
  ...
  const removeOutdatedSelection = React164.useCallback(() => {
  ...
  const handleSingleRowSelection = React164.useCallback((id, event) => {
  ...
  const handleRowClick = React164.useCallback((params, event) => {
    var _a;
  ...
  const preventSelectionOnShift = React164.useCallback((params, event) => {
    var _a;
    if (canHaveMultipleSelection && event.shiftKey) {
      (_a = window.getSelection()) == null ? void 0 : _a.removeAllRanges();
    }
  }, [canHaveMultipleSelection]);
  const handleRowSelectionCheckboxChange = React164.useCallback((params, event) => {
  ...
  const handleHeaderSelectionCheckboxChange = React164.useCallback((params) => {
  ...
  const handleCellKeyDown = React164.useCallback((params, event) => {
...
var useGridRowSelectionPreProcessors = (apiRef, props) => {
  ...
  const updateSelectionColumn = React165.useCallback((columnsState) => {
...
var useGridSorting = (apiRef, props) => {
  ...
  const upsertSortModel = React166.useCallback((field, sortItem) => {
  ...
  const createSortItem = React166.useCallback((col, directionOverride) => {
    const sortModel = gridSortModelSelector(apiRef);
  ...
  const addColumnMenuItem = React166.useCallback((columnMenuItems, colDef) => {
  ...
  const applySorting = React166.useCallback(() => {
    apiRef.current.setState((state) => {
  ...
  const setSortModel = React166.useCallback((model) => {
  ...
  const sortColumn = React166.useCallback((field, direction, allowMultipleSorting) => {
    const column = apiRef.current.getColumn(field);
  ...
  const getSortModel = React166.useCallback(() => gridSortModelSelector(apiRef), [apiRef]);
  const getSortedRows = React166.useCallback(() => {
    const sortedRows = gridSortedRowEntriesSelector(apiRef);
    return sortedRows.map((row) => row.model);
  }, [apiRef]);
  const getSortedRowIds = React166.useCallback(() => gridSortedRowIdsSelector(apiRef), [apiRef]);
  const getRowIdFromRowIndex = React166.useCallback((index) => apiRef.current.getSortedRowIds()[index], [apiRef]);
  const sortApi = {
    getSortModel,
    getSortedRows,
    getSortedRowIds,
  ...
  const stateExportPreProcessing = React166.useCallback((prevState, context) => {
    var _a2, _b2;
  ...
  const stateRestorePreProcessing = React166.useCallback((params, context) => {
    var _a2;
  ...
  const flatSortingMethod = React166.useCallback((params) => {
    const rowTree = gridRowTreeSelector(apiRef);
  ...
  const handleColumnHeaderClick = React166.useCallback(({
    field,
    colDef
  }, event) => {
  ...
  const handleColumnHeaderKeyDown = React166.useCallback(({
    field,
    colDef
  }, event) => {
    if (!colDef.sortable || props.disableColumnSorting) {
  ...
  const handleColumnsChange = React166.useCallback(() => {
    const sortModel = gridSortModelSelector(apiRef);
  ...
  const handleStrategyProcessorChange = React166.useCallback((methodName) => {
...
var useGridScroll = (apiRef, props) => {
  ...
  const scrollToIndexes = React167.useCallback((params) => {
    var _a;
    const dimensions = gridDimensionsSelector(apiRef.current.state);
  ...
  const scroll = React167.useCallback((params) => {
  ...
  const getScrollPosition = React167.useCallback(() => {
...
function useGridDimensions(apiRef, props) {
  ...
  const errorShown = React168.useRef(false);
  const rootDimensionsRef = React168.useRef(EMPTY_SIZE);
  ...
  const [savedSize, setSavedSize] = React168.useState();
  const debouncedSetSavedSize = React168.useMemo(() => throttle(setSavedSize, props.resizeThrottleMs), [props.resizeThrottleMs]);
  const previousSize = React168.useRef();
  ...
  const resize = React168.useCallback(() => {
  ...
  const getViewportPageSize = React168.useCallback(() => {
    const dimensions = gridDimensionsSelector(apiRef.current.state);
  ...
  const updateDimensions = React168.useCallback(() => {
    var _a, _b;
  ...
  const isFirstSizing = React168.useRef(true);
  const handleResize = React168.useCallback((size) => {
...
function GridColumnGroupHeader(props) {
  ...
  const rootProps = useGridRootProps();
  const headerCellRef = React169.useRef(null);
  const apiRef = useGridApiContext();
  ...
  const renderParams = React169.useMemo(() => ({
    groupId,
    headerName,
    description,
    depth,
  ...
  const publish = React169.useCallback(
    (eventName) => (event) => {
      if (isEventTargetInPortal(event)) {
        return;
      }
  ...
  const mouseEventsHandlers = React169.useMemo(() => ({
...
var useGridColumnHeaders = (props) => {
  ...
  const [dragCol, setDragCol] = React170.useState("");
  const [resizeCol, setResizeCol] = React170.useState("");
  const apiRef = useGridPrivateApiContext();
  const isRtl = useRtl();
  const rootProps = useGridRootProps();
  const dimensions = useGridSelector(apiRef, gridDimensionsSelector);
  ...
  const handleColumnResizeStart = React170.useCallback((params) => setResizeCol(params.field), []);
  const handleColumnResizeStop = React170.useCallback(() => setResizeCol(""), []);
  const handleColumnReorderStart = React170.useCallback((params) => setDragCol(params.field), []);
  const handleColumnReorderStop = React170.useCallback(() => setDragCol(""), []);
  const leftRenderContext = React170.useMemo(() => {
    return pinnedColumns.left.length ? {
      firstColumnIndex: 0,
      lastColumnIndex: pinnedColumns.left.length
    } : null;
  }, [pinnedColumns.left.length]);
  const rightRenderContext = React170.useMemo(() => {
  ...
  const getFillers = (params, children, leftOverflow, borderBottom2 = false) => {
    ...
    return (0, import_jsx_runtime100.jsxs)(React170.Fragment, {
      children: [isNotPinned && (0, import_jsx_runtime100.jsx)("div", {
        role: "presentation",
        style: {
      ...
      }), hasScrollbarFiller && (0, import_jsx_runtime100.jsx)(GridScrollbarFillerCell, {
        header: true,
  ...
  const getColumnHeaders = (params, other = {}) => {
    ...
    for (let i = 0; i < renderedColumns.length; i += 1) {
      ...
      columns.push((0, import_jsx_runtime100.jsx)(Memoized3, _extends({}, sortColumnLookup[colDef.field], {
        columnMenuOpen: open,
  ...
  const getColumnHeadersRow = () => {
    return (0, import_jsx_runtime100.jsxs)(GridColumnHeaderRow, {
      role: "row",
  ...
  const getColumnGroupHeadersRows = () => {
    ...
    for (let depth = 0; depth < headerGroupingMaxDepth; depth += 1) {
      headerRows.push((0, import_jsx_runtime100.jsxs)(GridColumnHeaderRow, {
        role: "row",
...
var GridBaseColumnHeaders = React171.forwardRef(function GridColumnHeaders(props, ref) {
  const {
    className
...
var GridColumnHeaders2 = React172.forwardRef(function GridColumnHeaders3(props, ref) {
  const {
    visibleColumns,
    sortColumnLookup,
    filterColumnLookup,
  ...
  return (0, import_jsx_runtime102.jsxs)(GridBaseColumnHeaders, _extends({
    ref
  }, other, getInnerProps(), {
...
true ? GridColumnHeaders2.propTypes = {
  ...
  // | To update them edit the TypeScript types and run "pnpm proptypes"  |
  // ----------------------------------------------------------------------
  columnGroupHeaderFocus: import_prop_types80.default.shape({
    depth: import_prop_types80.default.number.isRequired,
    field: import_prop_types80.default.string.isRequired
  }),
  columnGroupHeaderTabIndexState: import_prop_types80.default.shape({
    depth: import_prop_types80.default.number.isRequired,
    field: import_prop_types80.default.string.isRequired
  }),
  columnGroupsHeaderStructure: import_prop_types80.default.arrayOf(import_prop_types80.default.arrayOf(import_prop_types80.default.shape({
    columnFields: import_prop_types80.default.arrayOf(import_prop_types80.default.string).isRequired,
    groupId: import_prop_types80.default.string
  }))).isRequired,
  columnHeaderFocus: import_prop_types80.default.shape({
    field: import_prop_types80.default.string.isRequired
  }),
  columnHeaderTabIndexState: import_prop_types80.default.shape({
    field: import_prop_types80.default.string.isRequired
  }),
  columnMenuState: import_prop_types80.default.shape({
    field: import_prop_types80.default.string,
    open: import_prop_types80.default.bool.isRequired
  }).isRequired,
  columnVisibility: import_prop_types80.default.object.isRequired,
  filterColumnLookup: import_prop_types80.default.object.isRequired,
  hasOtherElementInTabSequence: import_prop_types80.default.bool.isRequired,
  headerGroupingMaxDepth: import_prop_types80.default.number.isRequired,
  sortColumnLookup: import_prop_types80.default.object.isRequired,
  visibleColumns: import_prop_types80.default.arrayOf(import_prop_types80.default.object).isRequired
} : void 0;
...
var GridNoResultsOverlay = React173.forwardRef(function GridNoResultsOverlay2(props, ref) {
  const apiRef = useGridApiContext();
...
var GridColumnUnsortedIcon = React174.memo(function GridColumnHeaderSortIcon2(props) {
  const {
    sortingOrder
  ...
  return Icon ? (0, import_jsx_runtime104.jsx)(Icon, _extends({}, other)) : null;
});
...
function MUISelectOption(_ref) {
  ...
  if (native) {
    return (0, import_jsx_runtime105.jsx)("option", _extends({}, props));
  }
  return (0, import_jsx_runtime105.jsx)(MenuItem_default, _extends({}, props));
}
...
function useProps(allProps) {
  return React176.useMemo(() => groupForwardedProps(allProps), [allProps]);
}
...
var useDataGridProps = (inProps) => {
  ...
  const localeText = React177.useMemo(() => _extends({}, GRID_DEFAULT_LOCALE_TEXT, themedProps.localeText), [themedProps.localeText]);
  const slots = React177.useMemo(() => computeSlots({
    defaultSlots,
    slots: themedProps.slots
  }), [themedProps.slots]);
  const injectDefaultProps = React177.useMemo(() => {
    return Object.keys(DATA_GRID_PROPS_DEFAULT_VALUES).reduce((acc, key) => {
      acc[key] = themedProps[key] ?? DATA_GRID_PROPS_DEFAULT_VALUES[key];
      return acc;
    }, {});
  }, [themedProps]);
  return React177.useMemo(() => _extends({}, themedProps, injectDefaultProps, {
    localeText,
    slots
...
var useGridRowsMeta = (apiRef, props) => {
  ...
  const rowsHeightLookup = React178.useRef(/* @__PURE__ */ Object.create(null));
  const lastMeasuredRowIndex = React178.useRef(-1);
  const hasRowWithAutoHeight = React178.useRef(false);
  const densityFactor = useGridSelector(apiRef, gridDensityFactorSelector);
  const filterModel = useGridSelector(apiRef, gridFilterModelSelector);
  ...
  const hydrateRowsMeta = React178.useCallback(() => {
    var _a, _b;
  ...
  const getRowHeight = React178.useCallback((rowId) => {
  ...
  const setRowHeight = React178.useCallback((id, height2) => {
    rowsHeightLookup.current[id].sizes.baseCenter = height2;
    rowsHeightLookup.current[id].isResized = true;
    rowsHeightLookup.current[id].needsFirstMeasurement = false;
    hydrateRowsMeta();
  }, [hydrateRowsMeta]);
  const debouncedHydrateRowsMeta = React178.useMemo(() => debounce(hydrateRowsMeta, props.rowPositionsDebounceMs), [hydrateRowsMeta, props.rowPositionsDebounceMs]);
  const storeMeasuredRowHeight = React178.useCallback((id, height2) => {
  ...
  const rowHasAutoHeight = React178.useCallback((id) => {
    var _a;
    return ((_a = rowsHeightLookup.current[id]) == null ? void 0 : _a.autoHeight) || false;
  }, []);
  const getLastMeasuredRowIndex = React178.useCallback(() => {
    return lastMeasuredRowIndex.current;
  }, []);
  const setLastMeasuredRowIndex = React178.useCallback((index) => {
    if (hasRowWithAutoHeight.current && index > lastMeasuredRowIndex.current) {
      lastMeasuredRowIndex.current = index;
    }
  }, []);
  const resetRowHeights = React178.useCallback(() => {
...
var useGridStatePersistence = (apiRef) => {
  const exportState = React179.useCallback((params = {}) => {
    const stateToExport = apiRef.current.unstable_applyPipeProcessors("exportState", {}, params);
    return stateToExport;
  }, [apiRef]);
  const restoreState = React179.useCallback((stateToRestore) => {
...
var useGridColumnSpanning = (apiRef) => {
  ...
  const calculateColSpan = React180.useCallback(({
    rowId,
    minFirstColumn,
    maxLastColumn,
    columns
...
var useGridColumnGrouping = (apiRef, props) => {
  const getColumnGroupPath = React181.useCallback((field) => {
    const unwrappedGroupingModel = gridColumnGroupsUnwrappedModelSelector(apiRef);
    return unwrappedGroupingModel[field] ?? [];
  }, [apiRef]);
  const getAllGroupDetails = React181.useCallback(() => {
  ...
  const handleColumnIndexChange = React181.useCallback(() => {
    const unwrappedGroupingModel = unwrapGroupingColumnModel(props.columnGroupingModel ?? []);
    apiRef.current.setState((state) => {
      var _a;
  ...
  const updateColumnGroupingState = React181.useCallback((columnGroupingModel) => {
    var _a, _b;
...
var useGridColumnResize = (apiRef, props) => {
  ...
  const initialOffsetToSeparator = React182.useRef();
  const resizeDirection = React182.useRef();
  const stopResizeEventTimeout = useTimeout();
  const touchId = React182.useRef();
  ...
  const stopListening = React182.useCallback(() => {
    const doc = ownerDocument(apiRef.current.rootElementRef.current);
  ...
  const handleResizeStart = React182.useCallback(({
    field
  }) => {
    apiRef.current.setState((state) => _extends({}, state, {
  ...
  const handleResizeStop = React182.useCallback(() => {
    apiRef.current.setState((state) => _extends({}, state, {
      columnResize: _extends({}, state.columnResize, {
        resizingColumnField: ""
      })
  ...
  const isAutosizingRef = React182.useRef(false);
  const autosizeColumns = React182.useCallback(async (userOptions) => {
    var _a;
  ...
  React182.useEffect(() => stopListening, [stopListening]);
  useOnMount(() => {
...
var useGridRowSpanning = (apiRef, props) => {
  ...
  const lastRange = React183.useRef(EMPTY_RANGE);
  const updateRowSpanningState = React183.useCallback(
  ...
  const prevRenderContext = React183.useRef(renderContext);
  const isFirstRender = React183.useRef(true);
  const shouldResetState = React183.useRef(false);
  React183.useEffect(() => {
...
var DataGridRaw = React184.forwardRef(function DataGrid(inProps, ref) {
  ...
  return (0, import_jsx_runtime106.jsx)(GridContextProvider, {
    ...
    configuration,
    props,
    children: (0, import_jsx_runtime106.jsxs)(GridRoot, _extends({
      className: props.className,
      style: props.style,
      sx: props.sx,
      ref
    }, props.forwardedProps, {
      children: [(0, import_jsx_runtime106.jsx)(GridHeader, {}), (0, import_jsx_runtime106.jsx)(GridVirtualScroller, {}), (0, import_jsx_runtime106.jsx)(GridFooterPlaceholder, {})]
    }))
  });
});
var DataGrid2 = React184.memo(DataGridRaw);
DataGridRaw.propTypes = {
   ...
   * @default false
   */
  autoHeight: import_prop_types81.default.bool,
  /**
   * If `true`, the pageSize is calculated according to the container size and the max number of rows to avoid rendering a vertical scroll bar.
   * @default false
   */
  autoPageSize: import_prop_types81.default.bool,
  /**
   * If `true`, columns are autosized after the datagrid is mounted.
   * @default false
   */
  autosizeOnMount: import_prop_types81.default.bool,
  /**
   * The options for autosize when user-initiated.
   */
  autosizeOptions: import_prop_types81.default.shape({
    columns: import_prop_types81.default.arrayOf(import_prop_types81.default.string),
    expand: import_prop_types81.default.bool,
    includeHeaders: import_prop_types81.default.bool,
    includeOutliers: import_prop_types81.default.bool,
    outliersFactor: import_prop_types81.default.number
  }),
  /**
   * Controls the modes of the cells.
   */
  cellModesModel: import_prop_types81.default.object,
  /**
   * If `true`, the Data Grid will display an extra column with checkboxes for selecting rows.
   * @default false
   */
  checkboxSelection: import_prop_types81.default.bool,
  /**
   * Override or extend the styles applied to the component.
   */
   ...
   * @default '\t'
   */
  clipboardCopyCellDelimiter: import_prop_types81.default.string,
  /**
   * Column region in pixels to render before/after the viewport
   * @default 150
   */
  columnBufferPx: import_prop_types81.default.number,
  /**
   * Sets the height in pixels of the column group headers in the Data Grid.
   * Inherits the `columnHeaderHeight` value if not set.
   */
  columnGroupHeaderHeight: import_prop_types81.default.number,
  columnGroupingModel: import_prop_types81.default.arrayOf(import_prop_types81.default.object),
  /**
   * Sets the height in pixel of the column headers in the Data Grid.
   * @default 56
   */
  columnHeaderHeight: import_prop_types81.default.number,
  /**
   * Set of columns of type [[GridColDef]][].
   */
  columns: import_prop_types81.default.arrayOf(import_prop_types81.default.object).isRequired,
  /**
   * Set the column visibility model of the Data Grid.
   * If defined, the Data Grid will ignore the `hide` property in [[GridColDef]].
   */
  columnVisibilityModel: import_prop_types81.default.object,
  /**
   * Set the density of the Data Grid.
   * @default "standard"
   */
  density: import_prop_types81.default.oneOf(["comfortable", "compact", "standard"]),
  /**
   * If `true`, column autosizing on header separator double-click is disabled.
   * @default false
   */
  disableAutosize: import_prop_types81.default.bool,
  /**
   * If `true`, column filters are disabled.
   * @default false
   */
  disableColumnFilter: import_prop_types81.default.bool,
  /**
   * If `true`, the column menu is disabled.
   * @default false
   */
  disableColumnMenu: import_prop_types81.default.bool,
  /**
   * If `true`, resizing columns is disabled.
   * @default false
   */
  disableColumnResize: import_prop_types81.default.bool,
  /**
   * If `true`, hiding/showing columns is disabled.
   * @default false
   */
  disableColumnSelector: import_prop_types81.default.bool,
  /**
   * If `true`, the column sorting feature will be disabled.
   * @default false
   */
  disableColumnSorting: import_prop_types81.default.bool,
  /**
   * If `true`, the density selector is disabled.
   * @default false
   */
  disableDensitySelector: import_prop_types81.default.bool,
  /**
   * If `true`, `eval()` is not used for performance optimization.
   * @default false
   */
  disableEval: import_prop_types81.default.bool,
  /**
   * If `true`, multiple selection using the Ctrl/CMD or Shift key is disabled.
   * The MIT DataGrid will ignore this prop, unless `checkboxSelection` is enabled.
   * @default false (`!props.checkboxSelection` for MIT Data Grid)
   */
  disableMultipleRowSelection: import_prop_types81.default.bool,
  /**
   * If `true`, the selection on click on a row or cell is disabled.
   * @default false
   */
  disableRowSelectionOnClick: import_prop_types81.default.bool,
  /**
   * If `true`, the virtualization is disabled.
   * @default false
   */
  disableVirtualization: import_prop_types81.default.bool,
  /**
   * Controls whether to use the cell or row editing.
   * @default "cell"
   */
  editMode: import_prop_types81.default.oneOf(["cell", "row"]),
  /**
   * Use if the actual rowCount is not known upfront, but an estimation is available.
   * If some rows have children (for instance in the tree data), this number represents the amount of top level rows.
   * Applicable only with `paginationMode="server"` and when `rowCount="-1"`
   */
  estimatedRowCount: import_prop_types81.default.number,
  /**
   * Unstable features, breaking changes might be introduced.
   * For each feature, if the flag is not explicitly set to `true`, the feature will be fully disabled and any property / method call will not have any effect.
   */
  experimentalFeatures: import_prop_types81.default.shape({
    warnIfFocusStateIsNotSynced: import_prop_types81.default.bool
  }),
  /**
   * The milliseconds delay to wait after a keystroke before triggering filtering.
   * @default 150
   */
  filterDebounceMs: import_prop_types81.default.number,
  /**
   * Filtering can be processed on the server or client-side.
   * Set it to 'server' if you would like to handle filtering on the server-side.
   * @default "client"
   */
  filterMode: import_prop_types81.default.oneOf(["client", "server"]),
  /**
   * Set the filter model of the Data Grid.
   */
  filterModel: import_prop_types81.default.shape({
    items: import_prop_types81.default.arrayOf(import_prop_types81.default.shape({
    ...
    logicOperator: import_prop_types81.default.oneOf(["and", "or"]),
    quickFilterExcludeHiddenColumns: import_prop_types81.default.bool,
    quickFilterLogicOperator: import_prop_types81.default.oneOf(["and", "or"]),
    quickFilterValues: import_prop_types81.default.array
  }),
  /**
   * Forwarded props for the Data Grid root element.
   * @ignore - do not document.
   */
  forwardedProps: import_prop_types81.default.object,
  /**
   * Function that applies CSS classes dynamically on cells.
   * @param {GridCellParams} params With all properties from [[GridCellParams]].
   * @returns {string} The CSS class to apply to the cell.
   */
  getCellClassName: import_prop_types81.default.func,
  /**
   * Function that returns the element to render in row detail.
   * @param {GridRowParams} params With all properties from [[GridRowParams]].
   * @returns {React.JSX.Element} The row detail element.
   */
  getDetailPanelContent: import_prop_types81.default.func,
  /**
   ...
   */
  getEstimatedRowHeight: import_prop_types81.default.func,
  /**
   * Function that applies CSS classes dynamically on rows.
   * @param {GridRowClassNameParams} params With all properties from [[GridRowClassNameParams]].
   * @returns {string} The CSS class to apply to the row.
   */
  getRowClassName: import_prop_types81.default.func,
  /**
   * Function that sets the row height per row.
   * @param {GridRowHeightParams} params With all properties from [[GridRowHeightParams]].
   * @returns {GridRowHeightReturnValue} The row height value. If `null` or `undefined` then the default row height is applied. If "auto" then the row height is calculated based on the content.
   */
  getRowHeight: import_prop_types81.default.func,
  /**
   * Return the id of a given [[GridRowModel]].
   */
  getRowId: import_prop_types81.default.func,
  /**
   * Function that allows to specify the spacing between rows.
   * @param {GridRowSpacingParams} params With all properties from [[GridRowSpacingParams]].
   * @returns {GridRowSpacing} The row spacing values.
   */
  getRowSpacing: import_prop_types81.default.func,
  /**
   * If `true`, the footer component is hidden.
   * @default false
   */
  hideFooter: import_prop_types81.default.bool,
  /**
   * If `true`, the pagination component in the footer is hidden.
   * @default false
   */
  hideFooterPagination: import_prop_types81.default.bool,
  /**
   * If `true`, the selected row count in the footer is hidden.
   * @default false
   */
  hideFooterSelectedRowCount: import_prop_types81.default.bool,
  /**
   * If `true`, the diacritics (accents) are ignored when filtering or quick filtering.
   * E.g. when filter value is `cafe`, the rows with `café` will be visible.
   * @default false
   */
  ignoreDiacritics: import_prop_types81.default.bool,
  /**
   * If `true`, the Data Grid will not use `valueFormatter` when exporting to CSV or copying to clipboard.
   * If an object is provided, you can choose to ignore the `valueFormatter` for CSV export or clipboard export.
   * @default false
   */
  ignoreValueFormatterDuringExport: import_prop_types81.default.oneOfType([import_prop_types81.default.shape({
    clipboardExport: import_prop_types81.default.bool,
    csvExport: import_prop_types81.default.bool
   ...
   * @default "deselect"
   */
  indeterminateCheckboxAction: import_prop_types81.default.oneOf(["deselect", "select"]),
  /**
   * The initial state of the DataGrid.
   * The data in it will be set in the state on initialization but will not be controlled.
   * If one of the data in `initialState` is also being controlled, then the control state wins.
   */
  initialState: import_prop_types81.default.object,
  /**
   * Callback fired when a cell is rendered, returns true if the cell is editable.
   * @param {GridCellParams} params With all properties from [[GridCellParams]].
   * @returns {boolean} A boolean indicating if the cell is editable.
   */
  isCellEditable: import_prop_types81.default.func,
  /**
   * Determines if a row can be selected.
   * @param {GridRowParams} params With all properties from [[GridRowParams]].
   * @returns {boolean} A boolean indicating if the row is selectable.
   */
  isRowSelectable: import_prop_types81.default.func,
  /**
   ...
   * @default false
   */
  keepNonExistentRowsSelected: import_prop_types81.default.bool,
  /**
   * If `true`, a loading overlay is displayed.
   * @default false
   */
  loading: import_prop_types81.default.bool,
  /**
   * Set the locale text of the Data Grid.
   * You can find all the translation keys supported in [the source](https://github.com/mui/mui-x/blob/HEAD/packages/x-data-grid/src/constants/localeTextConstants.ts) in the GitHub repository.
   */
  localeText: import_prop_types81.default.object,
  /**
   * Pass a custom logger in the components that implements the [[Logger]] interface.
   * @default console
   */
  logger: import_prop_types81.default.shape({
    debug: import_prop_types81.default.func.isRequired,
    error: import_prop_types81.default.func.isRequired,
    info: import_prop_types81.default.func.isRequired,
    warn: import_prop_types81.default.func.isRequired
  }),
  /**
   * Allows to pass the logging level or false to turn off logging.
   * @default "error" ("warn" in dev mode)
   */
  logLevel: import_prop_types81.default.oneOf(["debug", "error", "info", "warn", false]),
  /**
   * Nonce of the inline styles for [Content Security Policy](https://www.w3.org/TR/2016/REC-CSP2-20161215/#script-src-the-nonce-attribute).
   */
  nonce: import_prop_types81.default.string,
  /**
   ...
   */
  onCellClick: import_prop_types81.default.func,
  /**
   ...
   * @param {GridCallbackDetails} details Additional details for this callback.
   */
  onCellDoubleClick: import_prop_types81.default.func,
  /**
   * Callback fired when the cell turns to edit mode.
   * @param {GridCellParams} params With all properties from [[GridCellParams]].
   * @param {MuiEvent<React.KeyboardEvent | React.MouseEvent>} event The event that caused this prop to be called.
   */
  onCellEditStart: import_prop_types81.default.func,
  /**
   * Callback fired when the cell turns to view mode.
   * @param {GridCellParams} params With all properties from [[GridCellParams]].
   * @param {MuiEvent<MuiBaseEvent>} event The event that caused this prop to be called.
   */
  onCellEditStop: import_prop_types81.default.func,
  /**
   ...
   * @param {GridCallbackDetails} details Additional details for this callback.
   */
  onCellKeyDown: import_prop_types81.default.func,
  /**
   * Callback fired when the `cellModesModel` prop changes.
   * @param {GridCellModesModel} cellModesModel Object containing which cells are in "edit" mode.
   * @param {GridCallbackDetails} details Additional details for this callback.
   */
  onCellModesModelChange: import_prop_types81.default.func,
  /**
   * Callback called when the data is copied to the clipboard.
   * @param {string} data The data copied to the clipboard.
   */
  onClipboardCopy: import_prop_types81.default.func,
  /**
   ...
   * @param {GridCallbackDetails} details Additional details for this callback.
   */
  onColumnHeaderClick: import_prop_types81.default.func,
  /**
   ...
   * @param {GridCallbackDetails} details Additional details for this callback.
   */
  onColumnHeaderDoubleClick: import_prop_types81.default.func,
  /**
   ...
   * @param {GridCallbackDetails} details Additional details for this callback.
   */
  onColumnHeaderEnter: import_prop_types81.default.func,
  /**
   ...
   * @param {GridCallbackDetails} details Additional details for this callback.
   */
  onColumnHeaderLeave: import_prop_types81.default.func,
  /**
   ...
   * @param {GridCallbackDetails} details Additional details for this callback.
   */
  onColumnHeaderOut: import_prop_types81.default.func,
  /**
   ...
   * @param {GridCallbackDetails} details Additional details for this callback.
   */
  onColumnHeaderOver: import_prop_types81.default.func,
  /**
   ...
   * @param {GridCallbackDetails} details Additional details for this callback.
   */
  onColumnOrderChange: import_prop_types81.default.func,
  /**
   ...
   * @param {GridCallbackDetails} details Additional details for this callback.
   */
  onColumnResize: import_prop_types81.default.func,
  /**
   * Callback fired when the column visibility model changes.
   * @param {GridColumnVisibilityModel} model The new model.
   * @param {GridCallbackDetails} details Additional details for this callback.
   */
  onColumnVisibilityModelChange: import_prop_types81.default.func,
  /**
   ...
   * @param {GridCallbackDetails} details Additional details for this callback.
   */
  onColumnWidthChange: import_prop_types81.default.func,
  /**
   * Callback fired when the density changes.
   * @param {GridDensity} density New density value.
   */
  onDensityChange: import_prop_types81.default.func,
  /**
   * Callback fired when the Filter model changes before the filters are applied.
   * @param {GridFilterModel} model With all properties from [[GridFilterModel]].
   * @param {GridCallbackDetails} details Additional details for this callback.
   */
  onFilterModelChange: import_prop_types81.default.func,
  /**
   ...
   * @param {GridCallbackDetails} details Additional details for this callback.
   */
  onMenuClose: import_prop_types81.default.func,
  /**
   ...
   * @param {GridCallbackDetails} details Additional details for this callback.
   */
  onMenuOpen: import_prop_types81.default.func,
  /**
   * Callback fired when the pagination meta has changed.
   * @param {GridPaginationMeta} paginationMeta Updated pagination meta.
   */
  onPaginationMetaChange: import_prop_types81.default.func,
  /**
   * Callback fired when the pagination model has changed.
   * @param {GridPaginationModel} model Updated pagination model.
   * @param {GridCallbackDetails} details Additional details for this callback.
   */
  onPaginationModelChange: import_prop_types81.default.func,
  /**
   ...
   * @param {GridCallbackDetails} details Additional details for this callback.
   */
  onPreferencePanelClose: import_prop_types81.default.func,
  /**
   ...
   * @param {GridCallbackDetails} details Additional details for this callback.
   */
  onPreferencePanelOpen: import_prop_types81.default.func,
  /**
   * Callback called when `processRowUpdate` throws an error or rejects.
   * @param {any} error The error thrown.
   */
  onProcessRowUpdateError: import_prop_types81.default.func,
  /**
   ...
   * @param {GridCallbackDetails} details Additional details for this callback.
   */
  onResize: import_prop_types81.default.func,
  /**
   ...
   * @param {GridCallbackDetails} details Additional details for this callback.
   */
  onRowClick: import_prop_types81.default.func,
  /**
   * Callback fired when the row count has changed.
   * @param {number} count Updated row count.
   */
  onRowCountChange: import_prop_types81.default.func,
  /**
   ...
   * @param {GridCallbackDetails} details Additional details for this callback.
   */
  onRowDoubleClick: import_prop_types81.default.func,
  /**
   * Callback fired when the row turns to edit mode.
   * @param {GridRowParams} params With all properties from [[GridRowParams]].
   * @param {MuiEvent<React.KeyboardEvent | React.MouseEvent>} event The event that caused this prop to be called.
   */
  onRowEditStart: import_prop_types81.default.func,
  /**
   * Callback fired when the row turns to view mode.
   * @param {GridRowParams} params With all properties from [[GridRowParams]].
   * @param {MuiEvent<MuiBaseEvent>} event The event that caused this prop to be called.
   */
  onRowEditStop: import_prop_types81.default.func,
  /**
   * Callback fired when the `rowModesModel` prop changes.
   * @param {GridRowModesModel} rowModesModel Object containing which rows are in "edit" mode.
   * @param {GridCallbackDetails} details Additional details for this callback.
   */
  onRowModesModelChange: import_prop_types81.default.func,
  /**
   * Callback fired when the selection state of one or multiple rows changes.
   * @param {GridRowSelectionModel} rowSelectionModel With all the row ids [[GridSelectionModel]].
   * @param {GridCallbackDetails} details Additional details for this callback.
   */
  onRowSelectionModelChange: import_prop_types81.default.func,
  /**
   * Callback fired when the sort model changes before a column is sorted.
   * @param {GridSortModel} model With all properties from [[GridSortModel]].
   * @param {GridCallbackDetails} details Additional details for this callback.
   */
  onSortModelChange: import_prop_types81.default.func,
  /**
   ...
   * @ignore - do not document.
   */
  onStateChange: import_prop_types81.default.func,
  /**
   * Select the pageSize dynamically using the component UI.
   * @default [25, 50, 100]
   */
  pageSizeOptions: import_prop_types81.default.arrayOf(import_prop_types81.default.oneOfType([import_prop_types81.default.number, import_prop_types81.default.shape({
    label: import_prop_types81.default.string.isRequired,
    value: import_prop_types81.default.number.isRequired
  })]).isRequired),
  pagination: import_prop_types81.default.oneOf([true]),
  /**
   * The extra information about the pagination state of the Data Grid.
   * Only applicable with `paginationMode="server"`.
   */
  paginationMeta: import_prop_types81.default.shape({
    hasNextPage: import_prop_types81.default.bool
  }),
  /**
   ...
   * @default "client"
   */
  paginationMode: import_prop_types81.default.oneOf(["client", "server"]),
  /**
   * The pagination model of type [[GridPaginationModel]] which refers to current `page` and `pageSize`.
   */
  paginationModel: import_prop_types81.default.shape({
    page: import_prop_types81.default.number.isRequired,
    pageSize: import_prop_types81.default.number.isRequired
  }),
  /**
   ...
   */
  processRowUpdate: import_prop_types81.default.func,
  /**
   * The milliseconds throttle delay for resizing the grid.
   * @default 60
   */
  resizeThrottleMs: import_prop_types81.default.number,
  /**
   * Row region in pixels to render before/after the viewport
   * @default 150
   */
  rowBufferPx: import_prop_types81.default.number,
  /**
   * Set the total number of rows, if it is different from the length of the value `rows` prop.
   * If some rows have children (for instance in the tree data), this number represents the amount of top level rows.
   * Only works with `paginationMode="server"`, ignored when `paginationMode="client"`.
   */
  rowCount: import_prop_types81.default.number,
  /**
   * Sets the height in pixel of a row in the Data Grid.
   * @default 52
   */
  rowHeight: import_prop_types81.default.number,
  /**
   * Controls the modes of the rows.
   */
  rowModesModel: import_prop_types81.default.object,
  /**
   ...
   * @default 166
   */
  rowPositionsDebounceMs: import_prop_types81.default.number,
  /**
   * Set of rows of type [[GridRowsProp]].
   * @default []
   */
  rows: import_prop_types81.default.arrayOf(import_prop_types81.default.object),
  /**
   * If `false`, the row selection mode is disabled.
   * @default true
   */
  rowSelection: import_prop_types81.default.bool,
  /**
   * Sets the row selection model of the Data Grid.
   */
  rowSelectionModel: import_prop_types81.default.oneOfType([import_prop_types81.default.arrayOf(import_prop_types81.default.oneOfType([import_prop_types81.default.number, import_prop_types81.default.string]).isRequired), import_prop_types81.default.number, import_prop_types81.default.string]),
  /**
   * Sets the type of space between rows added by `getRowSpacing`.
   * @default "margin"
   */
  rowSpacingType: import_prop_types81.default.oneOf(["border", "margin"]),
  /**
   * Override the height/width of the Data Grid inner scrollbar.
   */
  scrollbarSize: import_prop_types81.default.number,
  /**
   * If `true`, vertical borders will be displayed between cells.
   * @default false
   */
  showCellVerticalBorder: import_prop_types81.default.bool,
  /**
   * If `true`, vertical borders will be displayed between column header items.
   * @default false
   */
  showColumnVerticalBorder: import_prop_types81.default.bool,
  /**
   ...
   * @default "client"
   */
  sortingMode: import_prop_types81.default.oneOf(["client", "server"]),
  /**
   * The order of the sorting sequence.
   * @default ['asc', 'desc', null]
   */
  sortingOrder: import_prop_types81.default.arrayOf(import_prop_types81.default.oneOf(["asc", "desc"])),
  /**
   * Set the sort model of the Data Grid.
   */
  sortModel: import_prop_types81.default.arrayOf(import_prop_types81.default.shape({
    field: import_prop_types81.default.string.isRequired,
   ...
   * @default false
   */
  unstable_rowSpanning: import_prop_types81.default.bool
};
export {
